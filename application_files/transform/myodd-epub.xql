...
module namespace model="http://www.tei-c.org/pm/models/myodd/epub";
    ...
    $input !         (
            ...
            return
                            ...
                            if ($parameters?mode='index') then
                                (
                                    ...
                                    if (descendant::link) then
                                        ...
                                        (),
                                    if (child::note) then
                                        epub:block($config, ., ("tei-item5", css:map-rend-to-class(.)), note)
                                    else
                                        (),
                                    if (child::desc) then
                                        epub:block($config, ., ("tei-item6", css:map-rend-to-class(.)), desc)
                                    else
                                        (),
                                    if (child::ref) then
                                        let $params := 
                                        ...
                                        return
                                                                                epub:block(map:merge(($config, map:entry("template", true()))), ., ("tei-item7", css:map-rend-to-class(.)), $content)
                                    else
                                        ()
                                )
                    ...
                    case element(teiHeader) return
                        (
                            html:heading($config, ., ("tei-teiHeader10", css:map-rend-to-class(.)), .//titleStmt/title[@xml:lang='en'], 1),
                            html:heading($config, ., ("tei-teiHeader11", css:map-rend-to-class(.)), 'Metadata', 2),
                            if (.//correspDesc) then
                                html:heading($config, ., ("tei-teiHeader12", css:map-rend-to-class(.)), 'Correspondents', 3)
                            else
                                (),
                            if (.//correspDesc) then
                                epub:block($config, ., ("tei-teiHeader13", css:map-rend-to-class(.)), .//correspAction[@type='sent']/persName)
                            else
                                (),
                            if (.//correspDesc) then
                                epub:block($config, ., ("tei-teiHeader14", css:map-rend-to-class(.)), .//correspAction[@type='received']/persName)
                            else
                                (),
                            if (not(.//correspDesc)) then
                                epub:block($config, ., ("tei-teiHeader15", css:map-rend-to-class(.)), .//titleStmt/author/persName|.//creation/persName)
                            else
                                (),
                            epub:block($config, ., ("tei-teiHeader16", css:map-rend-to-class(.)), .//history/origin/p[@xml:lang='en']),
                            html:heading($config, ., ("tei-teiHeader17", css:map-rend-to-class(.)), 'Informations about the letter', 3),
                            epub:block($config, ., ("tei-teiHeader18", css:map-rend-to-class(.)), .//supportDesc/extent/measure[@xml:lang='en']),
                            epub:block($config, ., ("tei-teiHeader19", css:map-rend-to-class(.)), string-join(.//supportDesc/foliation/p[@xml:lang='en'], '. ')),
                            epub:block($config, ., ("tei-teiHeader20", css:map-rend-to-class(.)), .//supportDesc/condition/p[@xml:lang='en']),
                            if (not(.//accMat)) then
                                epub:block($config, ., ("tei-teiHeader21", css:map-rend-to-class(.)), .//accMat/p[@xml:lang='en'])
                            else
                                (),
                            epub:block($config, ., ("tei-teiHeader22", css:map-rend-to-class(.)), .),
                            html:heading($config, ., ("tei-teiHeader23", css:map-rend-to-class(.)), 'Collection history', 3),
                            epub:block($config, ., ("tei-teiHeader24", css:map-rend-to-class(.)), .//msIdentifier/idno),
                            epub:block($config, ., ("tei-teiHeader25", css:map-rend-to-class(.)), .//msIdentifier/collection),
                            epub:block($config, ., ("tei-teiHeader26", css:map-rend-to-class(.)), .//accMat/p[@xml:lang='en']),
                            epub:block($config, ., ("tei-teiHeader27", css:map-rend-to-class(.)), .),
                            epub:block($config, ., ("tei-teiHeader28", css:map-rend-to-class(.)), .//additions/p[@xml:lang='en']),
                            html:heading($config, ., ("tei-teiHeader29", css:map-rend-to-class(.)), 'Encoding', 3),
                            epub:block($config, ., ("tei-teiHeader30", css:map-rend-to-class(.)), .//projectDesc/p[@xml:lang='en']),
                            epub:block($config, ., ("tei-teiHeader31", css:map-rend-to-class(.)), .//principal/persName),
                            epub:block($config, ., ("tei-teiHeader32", css:map-rend-to-class(.)), .//respStmt[1]/persName),
                            epub:block($config, ., ("tei-teiHeader33", css:map-rend-to-class(.)), .//correction/p[@xml:lang='en']),
                            epub:block($config, ., ("tei-teiHeader34", css:map-rend-to-class(.)), .//hyphenation/p[@xml:lang='en']),
                            epub:block($config, ., ("tei-teiHeader35", css:map-rend-to-class(.)), .//publicationStmt/availability/licence),
                            epub:block($config, ., ("tei-teiHeader36", css:map-rend-to-class(.)), null)
                        )
                    ...
                    case element(supplied) return
                        if ($parameters?mode="corrections") then
                            (
                                if (@reason) then
                                    epub:alternate($config, ., ("tei-supplied1", css:map-rend-to-class(.)), ., ., concat("The characters has been supplied because the text is ", @reason))
                                else
                                    (),
                                if (not(@reason)) then
                                    epub:alternate($config, ., ("tei-supplied2", css:map-rend-to-class(.)), ., ., "The characters has been supplied")
                                else
                                    ()
                            )
                    ...
                    case element(milestone) return
                        if (@type="line") then
                            ...
                            return
                                                        epub:block(map:merge(($config, map:entry("template", true()))), ., ("tei-milestone1", css:map-rend-to-class(.)), $content)
                        else
                    ...
                    case element(label) return
                        if ($parameters?mode='index' and parent::event) then
                            ...
                            if ($parameters?mode='index') then
                                epub:block($config, ., ("tei-label2", css:map-rend-to-class(.)), .)
                            else
                                if ($parameters?mode='list') then
                                    epub:block($config, ., ("tei-label3", css:map-rend-to-class(.)), .)
                                else
                                    if (@hand and $parameters?mode="corrections") then
                                        epub:alternate($config, ., ("tei-label4", css:map-rend-to-class(.)), ., ., id(substring-after(@hand, '#'), root($parameters?root))/p[@xml:lang="en"])
                                    else
                                        if (parent::item) then
                                            let $params := 
                                                map {
                        ...
                        (
                            let $params := 
                                map {
                                    ...
                                    "hand": if (@hand) then 'color: #9D9D9D; font-family: cursive;' else '',
                                    "content": .
                                }

                                                        let $content := 
                                model:template-signed6($config, ., $params)
                            return
                                                        epub:block(map:merge(($config, map:entry("template", true()))), ., ("tei-signed6", css:map-rend-to-class(.)), $content)
                        )
                    ...
                    case element(anchor) return
                        if (preceding-sibling::delSpan) then
                            epub:block($config, ., ("tei-anchor1", css:map-rend-to-class(.)), "[End of the deletion]")
                        else
                            ...
                            if ($parameters?mode="original" or $parameters?mode="entities") then
                                ...
                                if (unclear) then
                                    ...
                                    if (sic and corr) then
                                        epub:alternate($config, ., ("tei-choice6", css:map-rend-to-class(.)), ., corr[1], sic[1])
                                    else
                    ...
                    case element(note) return
                        (
                            if (@hand and not(@type="foliation")) then
                                html:inline($config, ., ("tei-note8", css:map-rend-to-class(.)), .)
                            else
                                (),
                            if (@resp) then
                                epub:note($config, ., ("tei-note9", css:map-rend-to-class(.)), p[1], (), ())
                            else
                                (),
                            if (@type="foliation") then
                                epub:block($config, ., ("tei-note10", css:map-rend-to-class(.)), .)
                            else
                                ()
                        )
                    ...
                    case element(dateline) return
                        if (@rend="align(right)") then
                            epub:block($config, ., ("tei-dateline5", css:map-rend-to-class(.)), .)
                        else
                            if (@rend="align(center)") then
                                epub:block($config, ., ("tei-dateline6", css:map-rend-to-class(.)), .)
                            else
                                if (@rend="align(left)") then
                                    epub:block($config, ., ("tei-dateline7", css:map-rend-to-class(.)), .)
                                else
                                    if (@rend="indent") then
                                        epub:block($config, ., ("tei-dateline8", css:map-rend-to-class(.)), .)
                                    else
                    ...
                    case element(trailer) return
                        ...
                        return
                                                epub:block(map:merge(($config, map:entry("template", true()))), ., ("tei-trailer", css:map-rend-to-class(.)), $content)
                    ...
                    case element(revisionDesc) return
                        if ($parameters?header='short' and @status) then
                            ...
                            return
                                                        epub:block(map:merge(($config, map:entry("template", true()))), ., ("tei-revisionDesc1", "header-short", css:map-rend-to-class(.)), $content)
                        else
                    ...
                    case element(subst) return
                        if (del[@rend="overwritten"] and add) then
                            ...
                            if ((del[@rend="overwritten"] and add) and $parameters?mode="corrections") then
                                epub:alternate($config, ., ("tei-subst3", css:map-rend-to-class(.)), ., add, concat("This text has been overwritten: ", del))
                            else
                                if (del[@rend="overwritten"] and add) then
                                    epub:alternate($config, ., ("tei-subst4", css:map-rend-to-class(.)), ., add, del)
                                else
                                    $config?apply($config, ./node())
                    ...
                    case element(speaker) return
                        if (@rend="underline") then
                            ...
                            epub:block($config, ., ("tei-speaker2", css:map-rend-to-class(.)), .)
                    ...
                    case element(profileDesc) return
                        if ($parameters?mode="corresp" and child::correspContext) then
                            ...
                            if ($parameters?header='short' and child::abstract) then
                                epub:block($config, ., ("tei-profileDesc2", css:map-rend-to-class(.)), abstract/p)
                            else
                                if ($parameters?header='short' and child::correspDesc/correspAction[@type="sent"]/placeName) then
                                    ...
                                    return
                                                                        epub:block(map:merge(($config, map:entry("template", true()))), ., ("tei-profileDesc3", "header-short", css:map-rend-to-class(.)), $content)
                                else
                    ...
                    case element(text) return
                        if ($parameters?mode='list') then
                            epub:block($config, ., ("tei-text1", css:map-rend-to-class(.)), /body)
                        else
                    ...
                    case element(licence) return
                        if (@target) then
                            ...
                            epub:block($config, ., ("tei-licence2", css:map-rend-to-class(.)), .)
                    ...
                    case element(address) return
                        if (@rend='align(right)') then
                            epub:block($config, ., ("tei-address1", css:map-rend-to-class(.)), .)
                        else
                            if (@rend='align(left)') then
                                epub:block($config, ., ("tei-address2", css:map-rend-to-class(.)), .)
                            else
                                if (@rend='align(center)') then
                                    epub:block($config, ., ("tei-address3", css:map-rend-to-class(.)), .)
                                else
                                    (: More than one model without predicate found for ident address. Choosing first one. :)
                                    epub:block($config, ., ("tei-address4", css:map-rend-to-class(.)), .)
                    ...
                    case element(closer) return
                        ...
                        return
                                                epub:block(map:merge(($config, map:entry("template", true()))), ., ("tei-closer3", css:map-rend-to-class(.)), $content)
                    ...
                    case element(p) return
                        (
                            if (ancestor::teiHeader) then
                                html:inline($config, ., ("tei-p7", css:map-rend-to-class(.)), .)
                            else
                                (),
                            let $params := 
                                map {
                                    ...
                                    "content": .
                                                        ...
                                                        let $content := 
                                model:template-p8($config, ., $params)
                            return
                                                        html:paragraph(map:merge(($config, map:entry("template", true()))), ., ("tei-p8", css:map-rend-to-class(.)), $content),
                            if (not(@rend) and ancestor::text) then
                                html:paragraph($config, ., ("tei-p9", css:map-rend-to-class(.)), .)
                            else
                                ()
                        )
                    ...
                    case element(lb) return
                        if (preceding-sibling::item) then
                            epub:break($config, ., ("tei-lb1", css:map-rend-to-class(.)), ., 'line', @n)
                        else
                            if (not(@break="no") and ($parameters?mode="original" or $parameters?mode="entities")) then
                                ...
                                if ($parameters?mode='corrections') then
                                    epub:break($config, ., css:get-rendition(., ("tei-lb4", css:map-rend-to-class(.))), ., 'line', @n)
                                else
                                    $config?apply($config, ./node())
                    ...
                    case element(name) return
                        if ($parameters?mode='index') then
                            epub:block($config, ., ("tei-name1", css:map-rend-to-class(.)), .)
                        else
                    ...
                    case element(postscript) return
                        ...
                        return
                                                epub:block(map:merge(($config, map:entry("template", true()))), ., ("tei-postscript", css:map-rend-to-class(.)), $content)
                        ...
                        if ($parameters?mode='facets') then
                            (
                                if (descendant::persName) then
                                    ...
                                    (),
                                epub:block($config, ., ("tei-div2", css:map-rend-to-class(.)), for $n in .//persName group by $ref := $n/@ref order by $ref return $n[1]),
                                if (descendant::orgName) then
                                    html:heading($config, ., ("tei-div3", css:map-rend-to-class(.)), 'Organisations/Groups', 2)
                                else
                                    (),
                                epub:block($config, ., ("tei-div4", css:map-rend-to-class(.)), for $n in .//orgName group by $ref := $n/@ref order by $ref return $n[1]),
                                if (descendant::title[@ref]) then
                                    html:heading($config, ., ("tei-div5", css:map-rend-to-class(.)), "Bibliography", 2)
                                else
                                    (),
                                epub:block($config, ., ("tei-div6", css:map-rend-to-class(.)), for $n in .//title[@ref] group by $ref := $n/@ref order by $ref return $n[1]),
                                if (descendant::rs) then
                                    html:heading($config, ., ("tei-div7", css:map-rend-to-class(.)), "Undefined references", 2)
                                else
                                    (),
                                epub:block($config, ., ("tei-div8", css:map-rend-to-class(.)), for $n in .//rs group by $ref := $n/@ref order by $ref return $n[1]),
                                if (descendant::term) then
                                    html:heading($config, ., ("tei-div9", css:map-rend-to-class(.)), "Terms", 2)
                                else
                                    (),
                                epub:block($config, ., ("tei-div10", css:map-rend-to-class(.)), for $n in .//term group by $ref := $n/@ref order by $ref return $n[1])
                            )

                        else
                            if ($parameters?mode='facets' and parent::body) then
                                (: facets rendition :)
                                epub:block($config, ., ("tei-div15", css:map-rend-to-class(.)), .)
                            else
                                if (@type='title_page') then
                                    epub:block($config, ., ("tei-div16", css:map-rend-to-class(.)), .)
                                else
                                    if (parent::body) then
                                        ...
                                        (
                                            html:heading($config, ., ("tei-div11", css:map-rend-to-class(.)), if (@type="transcription") then 'Transcription' else (if (@type="annex") then 'Annexe' else (if (@type="letter") then 'Letter' else 'Else')), 2),
                                            epub:block($config, ., ("tei-div12", css:map-rend-to-class(.)), .)
                                        )
                    ...
                    case element(add) return
                        if (@hand and $parameters?mode='corrections') then
                            ...
                            return
                                                        epub:alternate(map:merge(($config, map:entry("template", true()))), ., ("tei-add3", css:map-rend-to-class(.)), $content, ., concat("Additions made by: ", id(substring-after(@hand, '#'), root($parameters?root))/p[@xml:lang="en"]))
                        else
                            if ($parameters?mode='corrections') then
                                (: for diplomatic view :)
                                epub:alternate($config, ., ("tei-add4", css:map-rend-to-class(.)), ., ., "Additions made by the major hand")
                            else
                                (: default model :)
                    ...
                    case element(head) return
                        (
                            if (@hand and @rend="center underline") then
                                html:inline($config, ., ("tei-head2", css:map-rend-to-class(.)), .)
                            else
                                (),
                    ...
                    case element(salute) return
                        if (@rend="align(right)") then
                            epub:block($config, ., ("tei-salute9", css:map-rend-to-class(.)), .)
                        else
                            if (@rend="align(center)") then
                                epub:block($config, ., ("tei-salute10", css:map-rend-to-class(.)), .)
                            else
                                if (@rend="align(left)") then
                                    epub:block($config, ., ("tei-salute11", css:map-rend-to-class(.)), .)
                                else
                                    if (@rend="indent") then
                                        epub:block($config, ., ("tei-salute12", css:map-rend-to-class(.)), .)
                                    else
                    ...
                    case element(unclear) return
                        if ($parameters?mode="corrections") then
                            (
                                if (@reason) then
                                    epub:alternate($config, ., ("tei-unclear1", css:map-rend-to-class(.)), ., ., concat("The characters are unclear because the text is ", @reason))
                                else
                                    (),
                                if (not(@reason)) then
                                    epub:alternate($config, ., ("tei-unclear2", css:map-rend-to-class(.)), ., ., "Unclear character(s)")
                                else
                                    ()
                            )
                    ...
                    case element(argument) return
                        (: epub output :)
                        epub:block($config, ., ("tei-argument1", css:map-rend-to-class(.)), .)
                        ...
                        if ($parameters?mode='facets') then
                            ...
                            if ($parameters?mode='entities' and (@type="bi" and id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/bi/indexes/Werkindex.xml"))) or (@type="pec" and id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/pec/index/Index_biblio.xml"))) or (@type="ehri" and id(substring-after(@ref, '#'), root($parameters?root)))) then
                                ...
                                if (@rend="align(right) underline") then
                                    epub:block($config, ., ("tei-title18", css:map-rend-to-class(.)), .)
                                else
                                    if (@rend="align(right)") then
                                        epub:block($config, ., ("tei-title19", css:map-rend-to-class(.)), .)
                                    else
                                        if (@rend="align(center) underline") then
                                            epub:block($config, ., ("tei-title20", css:map-rend-to-class(.)), .)
                                        else
                                            if (@rend="align(center)") then
                                                epub:block($config, ., ("tei-title21", css:map-rend-to-class(.)), .)
                                            else
                    ...
                    case element(titleStmt) return
                        if ($parameters?mode='metadata-fr') then
                            epub:block($config, ., ("tei-titleStmt1", css:map-rend-to-class(.)), .)
                        else
                            if ($parameters?mode='metadata-en') then
                                epub:block($config, ., ("tei-titleStmt2", css:map-rend-to-class(.)), .)
                            else
                                if ($parameters?mode='metadata-de') then
                                    epub:block($config, ., ("tei-titleStmt3", css:map-rend-to-class(.)), .)
                                else
                                        ...
                                        if ($parameters?header='short') then
                                            (
                                                ...
                                                if (title[@xml:lang="de"]) then
                                                    epub:block($config, ., ("tei-titleStmt8", css:map-rend-to-class(.)), title[@xml:lang="de"])
                                                else
                                                    (),
                                                if (not(title[@xml:lang="de"])) then
                                                    epub:block($config, ., ("tei-titleStmt9", css:map-rend-to-class(.)), title[@xml:lang="fr"])
                                                else
                                                    (),
                                                if (author) then
                                                    let $params := 
                                                    ...
                                                    return
                                                                                                        epub:block(map:merge(($config, map:entry("template", true()))), ., ("tei-titleStmt10", css:map-rend-to-class(.)), $content)
                                                else
                                                    (),
                                                epub:block($config, ., ("tei-titleStmt11", css:map-rend-to-class(.)), author/affiliation/orgName)
                                            )

                                        else
                                            (: More than one model without predicate found for ident titleStmt. Choosing first one. :)
                                            html:heading($config, ., ("tei-titleStmt5", css:map-rend-to-class(.)), title[@xml:lang="en"], ())
                    ...
                    case element(body) return
                        (
                            epub:block($config, ., ("tei-body1", css:map-rend-to-class(.)), for $n in .//place group by $ref := $n/placeName[1] order by $ref return $n),
                            epub:block($config, ., ("tei-body2", css:map-rend-to-class(.)), for $n in .//person group by $ref := $n/persName[1] order by $ref return $n),
                            epub:block($config, ., ("tei-body3", css:map-rend-to-class(.)), for $n in .//org group by $ref := $n/orgName[1] order by $ref return $n)
                        )
                    ...
                    case element(fw) return
                        if (@type='letterhead' and @place="top(right)") then
                            ...
                            return
                                                        epub:block(map:merge(($config, map:entry("template", true()))), ., ("tei-fw1", css:map-rend-to-class(.)), $content)
                        else
                            if (@type='letterhead' and @place="top(center)") then
                                ...
                                if (@type='letterhead') then
                                    ...
                                    if (ancestor::opener or ancestor::div) then
                                        ...
                                        epub:block($config, ., ("tei-fw5", css:map-rend-to-class(.)), .)
                    case element(encodingDesc) return
                        html:omit($config, ., ("tei-encodingDesc", css:map-rend-to-class(.)), .)
                    case element(addrLine) return
                        if (@rend="align(right)") then
                            epub:block($config, ., ("tei-addrLine4", css:map-rend-to-class(.)), .)
                        else
                            if (@rend="align(center)") then
                                epub:block($config, ., ("tei-addrLine5", css:map-rend-to-class(.)), .)
                            else
                                if (@rend="align(left)") then
                                    epub:block($config, ., ("tei-addrLine6", css:map-rend-to-class(.)), .)
                                else
                                    if (@rend="indent") then
                                        epub:block($config, ., ("tei-addrLine7", css:map-rend-to-class(.)), .)
                                    else
                                        epub:block($config, ., ("tei-addrLine8", css:map-rend-to-class(.)), .)
                        ...
                        if ($parameters?mode='original' or $parameters?mode='entities') then
                            ...
                            if (desc and $parameters?mode='corrections') then
                                ...
                                if (@extent and $parameters?mode='corrections') then
                                    epub:alternate($config, ., ("tei-gap6", css:map-rend-to-class(.)), ., @extent, "This is a gap in the text")
                                else
                                    if (not(@extent) and $parameters?mode='corrections') then
                                        epub:alternate($config, ., ("tei-gap7", css:map-rend-to-class(.)), ., "[[...]]", "This is a gap in the text")
                                    else
                                        (
                                            let $params := 
                                                map {
                                            ...
                                            return
                                                                                        html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-gap3", css:map-rend-to-class(.)), $content)
                                        )
                    ...
                    case element(quote) return
                        if (ancestor::p) then
                            ...
                            return
                                                        epub:block(map:merge(($config, map:entry("template", true()))), ., css:get-rendition(., ("tei-quote2", css:map-rend-to-class(.))), $content)
                        ...
                        if (parent::education or parent::affiliation) then
                            ...
                            if ((parent::desc or parent::persName) and ancestor::org) then
                                ...
                                if (ancestor::person) then
                                    epub:block($config, ., ("tei-persName3", css:map-rend-to-class(.)), .)
                                else
                        ...
                        if ($parameters?mode='index') then
                            (
                                ...
                                if (child::persName) then
                                    epub:block($config, ., ("tei-person3", css:map-rend-to-class(.)), persName except persName[1])
                                else
                                    (),
                                if (child::note) then
                                    epub:block($config, ., ("tei-person4", css:map-rend-to-class(.)), note/p)
                                else
                                    (),
                                if (child::birth) then
                                    let $params := 
                                    ...
                                    return
                                                                        epub:block(map:merge(($config, map:entry("template", true()))), ., ("tei-person5", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (child::death) then
                                    let $params := 
                                    ...
                                    return
                                                                        epub:block(map:merge(($config, map:entry("template", true()))), ., ("tei-person6", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (child::nationality) then
                                    ...
                                    return
                                                                        epub:block(map:merge(($config, map:entry("template", true()))), ., ("tei-person7", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (child::sex) then
                                    let $params := 
                                    ...
                                    return
                                                                        epub:block(map:merge(($config, map:entry("template", true()))), ., ("tei-person8", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (child::occupation) then
                                    ...
                                    return
                                                                        epub:block(map:merge(($config, map:entry("template", true()))), ., ("tei-person9", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (child::education) then
                                    epub:block($config, ., ("tei-person10", css:map-rend-to-class(.)), education)
                                else
                                    (),
                                if (child::affiliation) then
                                    epub:block($config, ., ("tei-person11", css:map-rend-to-class(.)), affiliation)
                                else
                                    (),
                                if (child::event) then
                                    epub:block($config, ., ("tei-person12", css:map-rend-to-class(.)), event)
                                else
                                    (),
                                if (child::bibl) then
                                    epub:block($config, ., ("tei-person13", css:map-rend-to-class(.)), bibl)
                                else
                                    ()
                            )
                            ...
                            if ($parameters?mode='facets') then
                                (
                                    ...
                                    if (child::idno) then
                                        ...
                                        (),
                                    if (child::note) then
                                        epub:block($config, ., ("tei-person16", css:map-rend-to-class(.)), note/p)
                                    else
                                        (),
                                    if (child::birth) then
                                        let $params := 
                                        ...
                                        return
                                                                                epub:block(map:merge(($config, map:entry("template", true()))), ., ("tei-person17", css:map-rend-to-class(.)), $content)
                                    else
                                        (),
                                    if (child::death) then
                                        let $params := 
                                        ...
                                        return
                                                                                epub:block(map:merge(($config, map:entry("template", true()))), ., ("tei-person18", css:map-rend-to-class(.)), $content)
                                    else
                                        (),
                                    if (child::nationality) then
                                        let $params := 
                                        ...
                                        return
                                                                                epub:block(map:merge(($config, map:entry("template", true()))), ., ("tei-person19", css:map-rend-to-class(.)), $content)
                                    else
                                        (),
                                    if (child::sex) then
                                        let $params := 
                                        ...
                                        return
                                                                                epub:block(map:merge(($config, map:entry("template", true()))), ., ("tei-person20", css:map-rend-to-class(.)), $content)
                                    else
                                        (),
                                    if (child::occupation) then
                                        let $params := 
                                        ...
                                        return
                                                                                epub:block(map:merge(($config, map:entry("template", true()))), ., ("tei-person21", css:map-rend-to-class(.)), $content)
                                    else
                                        (),
                                    if (child::education) then
                                        epub:block($config, ., ("tei-person22", css:map-rend-to-class(.)), education)
                                    else
                                        (),
                                    if (child::affiliation) then
                                        epub:block($config, ., ("tei-person23", css:map-rend-to-class(.)), affiliation)
                                    else
                                        (),
                                    if (child::event) then
                                        epub:block($config, ., ("tei-person24", css:map-rend-to-class(.)), event)
                                    else
                                        ()
                                )
                                            ...
                                            let $params := 
                                                map {
                                                    ...
                                                    "viaf": idno
                                                                                        ...
                                                                                        let $content := 
                                                model:template-person27($config, ., $params)
                                            return
                                                                                        epub:block(map:merge(($config, map:entry("template", true()))), ., ("tei-person27", css:map-rend-to-class(.)), $content),
                                            let $params := 
                                                map {
                                                    "date": birth/date[@when-iso],
                                                    "place": birth/placeName,
                                                    "content": .
                                                }

                                                                                        let $content := 
                                                model:template-person28($config, ., $params)
                                            return
                                                                                        epub:block(map:merge(($config, map:entry("template", true()))), ., ("tei-person28", css:map-rend-to-class(.)), $content),
                                            let $params := 
                                                map {
                                                    "date": death/date[@when-iso],
                                                    "place": death/placeName,
                                                    "content": .
                                                }

                                                                                        let $content := 
                                                model:template-person29($config, ., $params)
                                            return
                                                                                        epub:block(map:merge(($config, map:entry("template", true()))), ., ("tei-person29", css:map-rend-to-class(.)), $content),
                                            let $params := 
                                                map {
                                                    "content": nationality
                                                }
                                                                                        ...
                                                                                        let $content := 
                                                model:template-person30($config, ., $params)
                                            return
                                                                                        epub:block(map:merge(($config, map:entry("template", true()))), ., ("tei-person30", css:map-rend-to-class(.)), $content),
                                            let $params := 
                                                map {
                                                    "content": sex
                                                }
                                                                                        ...
                                                                                        let $content := 
                                                model:template-person31($config, ., $params)
                                            return
                                                                                        epub:block(map:merge(($config, map:entry("template", true()))), ., ("tei-person31", css:map-rend-to-class(.)), $content),
                                            let $params := 
                                                map {
                                                    "content": string-join(occupation, '/')
                                                }
                                                                                        ...
                                                                                        let $content := 
                                                model:template-person32($config, ., $params)
                                            return
                                                                                        epub:block(map:merge(($config, map:entry("template", true()))), ., ("tei-person32", css:map-rend-to-class(.)), $content),
                                            let $params := 
                                                map {
                                                    "content": education
                                                }
                                                                                        ...
                                                                                        let $content := 
                                                model:template-person33($config, ., $params)
                                            return
                                                                                        epub:block(map:merge(($config, map:entry("template", true()))), ., ("tei-person33", css:map-rend-to-class(.)), $content),
                                            let $params := 
                                                map {
                                                    "content": event
                                                }
                                                                                        ...
                                                                                        let $content := 
                                                model:template-person34($config, ., $params)
                                            return
                                                                                        epub:block(map:merge(($config, map:entry("template", true()))), ., ("tei-person34", css:map-rend-to-class(.)), $content),
                                            html:inline($config, ., ("tei-person35", css:map-rend-to-class(.)), 'Affiliation:'),
                                            epub:block($config, ., ("tei-person36", css:map-rend-to-class(.)), affiliation)
                                        )
                                                        ...
                                                        if ($parameters?mode="entities" and @type="tgb" and id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/rochlitz/index/indices.xml"))/location/geo) then
                                                            ...
                                                            if ($parameters?mode="entities" and @type="pec" and id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/pec/index/Index_place.xml"))/location/geo) then
                                                                ...
                                                                if (@type="pec" and $parameters?mode='entities') then
                                                                    epub:alternate($config, ., ("tei-placeName11", css:map-rend-to-class(.)), ., ., id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/pec/index/Index_place.xml")))
                                                                else
                                                                    if (@type="bi" and $parameters?mode='entities') then
                                                                        epub:alternate($config, ., ("tei-placeName12", css:map-rend-to-class(.)), ., ., id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/bi/indexes/Ortsindex.xml")))
                                                                    else
                                                                        if (parent::org) then
                                                                            let $params := 
                                                                                map {
                    ...
                    case element(place) return
                        (
                            epub:block($config, ., ("tei-place1", css:map-rend-to-class(.)), placeName[1]),
                            epub:block($config, ., ("tei-place2", css:map-rend-to-class(.)), string-join(* except (location|idno), ', ')),
                            epub:block($config, ., ("tei-place3", css:map-rend-to-class(.)), string-join(location/address, ', ')),
                            epub:block($config, ., ("tei-place4", css:map-rend-to-class(.)), location/geo)
                        )
                        ...
                        if ($parameters?mode='facets') then
                            (
                                ...
                                if (child::idno) then
                                    ...
                                    (),
                                if (desc) then
                                    epub:block($config, ., ("tei-org3", css:map-rend-to-class(.)), desc[1])
                                else
                                    (),
                                if (note) then
                                    epub:block($config, ., ("tei-org4", css:map-rend-to-class(.)), note)
                                else
                                    (),
                                if (child::placeName/@from-iso) then
                                    ...
                                    return
                                                                        epub:block(map:merge(($config, map:entry("template", true()))), ., ("tei-org5", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (child::placeName/not(@from-iso)) then
                                    ...
                                    return
                                                                        epub:block(map:merge(($config, map:entry("template", true()))), ., ("tei-org6", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (placeName/location/geo) then
                                    epub:block($config, ., ("tei-org7", css:map-rend-to-class(.)), placeName/location/geo)
                                else
                                    (),
                                if (child::persName) then
                                    let $params := 
                            ...
                            if ($parameters?mode='index') then
                                (
                                    ...
                                    if (child::idno) then
                                        ...
                                        (),
                                    if (desc) then
                                        epub:block($config, ., ("tei-org11", css:map-rend-to-class(.)), desc[1])
                                    else
                                        (),
                                    if (note) then
                                        epub:block($config, ., ("tei-org12", css:map-rend-to-class(.)), note)
                                    else
                                        (),
                                    if (child::placeName/@from-iso) then
                                        let $params := 
                                        ...
                                        return
                                                                                epub:block(map:merge(($config, map:entry("template", true()))), ., ("tei-org13", css:map-rend-to-class(.)), $content)
                                    else
                                        (),
                                    if (child::placeName/not(@from-iso)) then
                                        let $params := 
                                        ...
                                        return
                                                                                epub:block(map:merge(($config, map:entry("template", true()))), ., ("tei-org14", css:map-rend-to-class(.)), $content)
                                    else
                                        (),
                                    if (placeName/location/geo) then
                                        epub:block($config, ., ("tei-org15", css:map-rend-to-class(.)), placeName/location/geo)
                                    else
                                        (),
                                    if (child::persName) then
                                        let $params := 
                                        ...
                                        return
                                                                                epub:block(map:merge(($config, map:entry("template", true()))), ., ("tei-org16", css:map-rend-to-class(.)), $content)
                                    else
                                        ()
                                )
                                        ...
                                        let $params := 
                                            map {
                                                ...
                                                "viaf": idno
                                                                                ...
                                                                                let $content := 
                                            model:template-org18($config, ., $params)
                                        return
                                                                                epub:block(map:merge(($config, map:entry("template", true()))), ., ("tei-org18", css:map-rend-to-class(.)), $content),
                                        epub:block($config, ., ("tei-org19", css:map-rend-to-class(.)), desc),
                                        let $params := 
                                            map {
                                                "content": string-join(placeName/* except placeName/location, ', '),
                                                "date": placeName
                                                                                ...
                                                                                let $content := 
                                            model:template-org20($config, ., $params)
                                        return
                                                                                epub:block(map:merge(($config, map:entry("template", true()))), ., ("tei-org20", css:map-rend-to-class(.)), $content)
                                    )
                    ...
                    case element(egXML) return
                        epub:block($config, ., ("tei-egXML1", css:map-rend-to-class(.)), text())
                    ...
                    case element(schemaSpec) return
                        ...
                        return
                                                epub:block(map:merge(($config, map:entry("template", true()))), ., ("tei-schemaSpec", css:map-rend-to-class(.)), $content)
                    ...
                    case element(stamp) return
                        if (ancestor::additions) then
                            ...
                            return
                                                        epub:block(map:merge(($config, map:entry("template", true()))), ., ("tei-stamp2", css:map-rend-to-class(.)), $content)
                    ...
                    case element(biblStruct) return
                        if ($parameters?mode='index') then
                            ...
                            if ($parameters?mode='list') then
                                ...
                                (: default rendition :)
                                epub:block($config, ., ("tei-biblStruct3", css:map-rend-to-class(.)), .)
                    ...
                    case element(metamark) return
                        ...
                        return
                                                epub:block(map:merge(($config, map:entry("template", true()))), ., ("tei-metamark3", css:map-rend-to-class(.)), $content)
                    case element(emph) return
                        html:inline($config, ., ("tei-emph", css:map-rend-to-class(.)), .)
                    case element(handShift) return
                        epub:alternate($config, ., ("tei-handShift", css:map-rend-to-class(.)), ., "[Shift in the document hand]", id(substring-after(@new, '#'), root($parameters?root))/p[@xml:lang="en"])
                    case element(delSpan) return
                        epub:alternate($config, ., ("tei-delSpan", css:map-rend-to-class(.)), ., "[From here, a large part of the text has been strikethrough]", id(substring-after(@hand, '#'), root($parameters?root))/p[@xml:lang="en"])
                    ...
                    case element(location) return
                        (
                            if (/geo) then
                                epub:alternate($config, ., ("tei-location", css:map-rend-to-class(.)), ., /geo, let $address := ../location/address let $placenames := string-join(../placeName/text(), ', ') let $geo := /geo  let $country := string-join(../country, ', ') return <div class='card_index'> {   if ($country) then     <p>{$country}</p>   else (),   if ($placenames) then     <p>{$placenames}</p>   else (),   if ($address) then     <p>Address:       {for $child in $address/*       return concat(string($child), ', ')}     </p>   else (),   if ($geo) then     <p>Location: <span style='color: blue;'>{$geo}</span></p>   else () } </div>)
                            else
                                ()
                        )
