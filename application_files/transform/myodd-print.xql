...
module namespace model="http://www.tei-c.org/pm/models/myodd/print";
            ...
            return
                        ...
                        if ($parameters?mode='facets') then
                            (
                                if (not(descendant::link)) then
                                    ...
                                    return
                                                                        html:webcomponent(map:merge(($config, map:entry("template", true()))), ., ("tei-item1", css:map-rend-to-class(.)), $content, 'pb-highlight', map {"key": @xml:id, "subscribe": 'letter', "emit": 'index'})
                                else
                                    (),
                                if (descendant::link) then
                                    ...
                                    return
                                                                        html:webcomponent(map:merge(($config, map:entry("template", true()))), ., ("tei-item2", css:map-rend-to-class(.)), $content, 'pb-highlight', map {"key": @xml:id, "subscribe": 'letter', "emit": 'index', "term": .//link/@target})
                                else
                                    ()
                            )
                            ...
                            if ($parameters?mode='index') then
                                (
                                    if (not(descendant::link)) then
                                        ...
                                        return
                                                                                html:webcomponent(map:merge(($config, map:entry("template", true()))), ., ("tei-item3", css:map-rend-to-class(.)), $content, 'pb-highlight', map {"key": @xml:id, "subscribe": 'letter', "emit": 'index'})
                                    else
                                        (),
                                    if (descendant::link) then
                                        let $params := 
                                        ...
                                        return
                                                                                html:webcomponent(map:merge(($config, map:entry("template", true()))), ., ("tei-item4", css:map-rend-to-class(.)), $content, 'pb-highlight', map {"key": @xml:id, "subscribe": 'letter', "emit": 'index', "term": .//link/@target})
                                    else
                                        (),
                                    if (child::note) then
                                        html:block($config, ., ("tei-item5", css:map-rend-to-class(.)), note)
                                    else
                                        (),
                                    if (child::desc) then
                                        html:block($config, ., ("tei-item6", css:map-rend-to-class(.)), desc)
                                    else
                                        (),
                                    if (child::ref) then
                                        let $params := 
                                        ...
                                        return
                                                                                html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-item7", css:map-rend-to-class(.)), $content)
                                    else
                                        ()
                                )
                                ...
                                if ($parameters?mode='list') then
                                    ...
                                    return
                                                                        html:webcomponent(map:merge(($config, map:entry("template", true()))), ., ("tei-item8", css:map-rend-to-class(.)), $content, 'pb-highlight', map {"key": @xml:id, "scroll": true(), "emit": 'letter'})
                                else
                                    if (preceding-sibling::label) then
                                        html:inline($config, ., ("tei-item9", css:map-rend-to-class(.)), .)
                                    else
                                        ...
                                        return
                                                                                html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-item10", css:map-rend-to-class(.)), $content)
                    case element(figure) return
                        html:figure($config, ., ("tei-figure1", css:map-rend-to-class(.)), ., ())
                    case element(teiHeader) return
                        if ($parameters?mode="navigation-prev" and descendant::correspContext/ref[@type='prev']) then
                            ...
                            return
                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader64", css:map-rend-to-class(.)), $content)
                        else
                            if ($parameters?mode="navigation-next" and descendant::correspContext/ref[@type='next']) then
                                ...
                                return
                                                                html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader65", css:map-rend-to-class(.)), $content)
                            else
                                if ($parameters?mode='licence') then
                                    html:inline($config, ., ("tei-teiHeader66", css:map-rend-to-class(.)), .//publicationStmt/availability/licence)
                                else
                                    if ($parameters?mode='citation') then
                                        ...
                                        return
                                                                                html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader67", css:map-rend-to-class(.)), $content)
                                    else
                                        if ($parameters?mode='metadata-fr') then
                                            (
                                                if (.//titleStmt/title[@xml:lang='fr']) then
                                                    ...
                                                    return
                                                                                                        html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader68", css:map-rend-to-class(.)), $content)
                                                else
                                                    (),
                                                if ((.//correspAction[@type='sent']/persName or .//correspAction[@type='sent']/orgName) or (.//correspAction[@type='received']/persName or .//correspAction[@type='received']/orgName)) then
                                                    ...
                                                    return
                                                                                                        html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader69", css:map-rend-to-class(.)), $content)
                                                else
                                                    (),
                                                if (.//correspAction[@type='sent']/persName or .//correspAction[@type='sent']/orgName) then
                                                    ...
                                                    return
                                                                                                        html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader70", css:map-rend-to-class(.)), $content, ())
                                                else
                                                    (),
                                                if (.//correspAction[@type='received']/persName or .//correspAction[@type='received']/orgName) then
                                                    ...
                                                    return
                                                                                                        html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader71", css:map-rend-to-class(.)), $content, ())
                                                else
                                                    (),
                                                if (.//titleStmt/author/persName|.//creation/persName and not(.//correspDesc)) then
                                                    ...
                                                    return
                                                                                                        html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader72", css:map-rend-to-class(.)), $content)
                                                else
                                                    (),
                                                if (.//history/origin/p[@xml:lang='fr'] or .//creation) then
                                                    ...
                                                    return
                                                                                                        html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader73", css:map-rend-to-class(.)), $content)
                                                else
                                                    (),
                                                if (.//supportDesc/extent/measure[@xml:lang='fr'] or .//supportDesc/foliation or .//supportDesc/condition/p[@xml:lang='fr'] or .//accMat/p[@xml:lang='fr']) then
                                                    ...
                                                    return
                                                                                                        html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader74", css:map-rend-to-class(.)), $content)
                                                else
                                                    (),
                                                if (.//supportDesc/extent/measure[@xml:lang='fr']) then
                                                    ...
                                                    return
                                                                                                        html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader75", css:map-rend-to-class(.)), $content, ())
                                                else
                                                    (),
                                                if (.//supportDesc/foliation/p[@xml:lang='fr']) then
                                                    ...
                                                    return
                                                                                                        html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader76", css:map-rend-to-class(.)), $content, ())
                                                else
                                                    (),
                                                if (.//supportDesc/condition) then
                                                    ...
                                                    return
                                                                                                        html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader77", css:map-rend-to-class(.)), $content, ())
                                                else
                                                    (),
                                                if (.//accMat/p[@xml:lang='fr']) then
                                                    ...
                                                    return
                                                                                                        html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader78", css:map-rend-to-class(.)), $content, ())
                                                else
                                                    (),
                                                if (.//msIdentifier/idno or .//msIdentifier/collection or (.//msIdentifier/repository or .//msIdentifier/institution) or .//acquisition or .//additions) then
                                                    ...
                                                    return
                                                                                                        html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader79", css:map-rend-to-class(.)), $content)
                                                else
                                                    (),
                                                if (.//msIdentifier/idno) then
                                                    ...
                                                    return
                                                                                                        html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader80", css:map-rend-to-class(.)), $content, ())
                                                else
                                                    (),
                                                if (.//msIdentifier/collection) then
                                                    ...
                                                    return
                                                                                                        html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader81", css:map-rend-to-class(.)), $content, ())
                                                else
                                                    (),
                                                if (.//msIdentifier/repository and .//msIdentifier/institution) then
                                                    ...
                                                    return
                                                                                                        html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader82", css:map-rend-to-class(.)), $content, ())
                                                else
                                                    (),
                                                if (.//msIdentifier/repository and not(.//msIdentifier/institution)) then
                                                    ...
                                                    return
                                                                                                        html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader83", css:map-rend-to-class(.)), $content, ())
                                                else
                                                    (),
                                                if (.//msIdentifier/institution and not(.//msIdentifier/repository)) then
                                                    ...
                                                    return
                                                                                                        html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader84", css:map-rend-to-class(.)), $content, ())
                                                else
                                                    (),
                                                if (.//acquisition/p[@xml:lang='fr']) then
                                                    ...
                                                    return
                                                                                                        html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader85", css:map-rend-to-class(.)), $content, ())
                                                else
                                                    (),
                                                if (.//additions/p[@xml:lang='fr']) then
                                                    ...
                                                    return
                                                                                                        html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader86", css:map-rend-to-class(.)), $content, ())
                                                else
                                                    (),
                                                if (.//projectDesc/p[@xml:lang='fr'] or .//principal or .//respStmt[1]/persName or .//correction/p[@xml:lang='fr'] or .//hyphenation/p[@xml:lang='fr']) then
                                                    ...
                                                    return
                                                                                                        html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader87", css:map-rend-to-class(.)), $content)
                                                else
                                                    (),
                                                if (.//projectDesc/p[@xml:lang='fr']) then
                                                    ...
                                                    return
                                                                                                        html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader88", css:map-rend-to-class(.)), $content, ())
                                                else
                                                    (),
                                                if (.//principal) then
                                                    let $params := 
                                                    ...
                                                    return
                                                                                                        html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader89", css:map-rend-to-class(.)), $content, ())
                                                else
                                                    (),
                                                if (.//respStmt[1]/persName) then
                                                    ...
                                                    return
                                                                                                        html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader90", css:map-rend-to-class(.)), $content, ())
                                                else
                                                    (),
                                                if (.//correction/p[@xml:lang='fr']) then
                                                    ...
                                                    return
                                                                                                        html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader91", css:map-rend-to-class(.)), $content, ())
                                                else
                                                    (),
                                                if (.//hyphenation/p[@xml:lang='fr']) then
                                                    ...
                                                    return
                                                                                                        html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader92", css:map-rend-to-class(.)), $content, ())
                                                else
                                                    ()
                                            )
                                            ...
                                            if ($parameters?mode='metadata-en') then
                                                (
                                                    if (.//titleStmt/title[@xml:lang='en']) then
                                                        ...
                                                        return
                                                                                                                html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader93", css:map-rend-to-class(.)), $content)
                                                    else
                                                        (),
                                                    if ((.//correspAction[@type='sent']/persName or .//correspAction[@type='sent']/orgName) or (.//correspAction[@type='received']/persName or .//correspAction[@type='received']/orgName)) then
                                                        let $params := 
                                                        ...
                                                        return
                                                                                                                html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader94", css:map-rend-to-class(.)), $content)
                                                    else
                                                        (),
                                                    if (.//correspAction[@type='sent']/persName or .//correspAction[@type='sent']/orgName) then
                                                        let $params := 
                                                        ...
                                                        return
                                                                                                                html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader95", css:map-rend-to-class(.)), $content, ())
                                                    else
                                                        (),
                                                    if (.//correspAction[@type='received']/persName or .//correspAction[@type='received']/orgName) then
                                                        let $params := 
                                                        ...
                                                        return
                                                                                                                html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader96", css:map-rend-to-class(.)), $content, ())
                                                    else
                                                        (),
                                                    if (.//titleStmt/author/persName|.//creation/persName and not(.//correspDesc)) then
                                                        let $params := 
                                                        ...
                                                        return
                                                                                                                html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader97", css:map-rend-to-class(.)), $content)
                                                    else
                                                        (),
                                                    if (.//history/origin/p[@xml:lang='en'] or .//creation) then
                                                        ...
                                                        return
                                                                                                                html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader98", css:map-rend-to-class(.)), $content)
                                                    else
                                                        (),
                                                    if (.//supportDesc/extent/measure[@xml:lang='en'] or .//supportDesc/foliation or .//supportDesc/condition/p[@xml:lang='en'] or .//accMat/p[@xml:lang='en']) then
                                                        ...
                                                        return
                                                                                                                html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader99", css:map-rend-to-class(.)), $content)
                                                    else
                                                        (),
                                                    if (.//supportDesc/extent/measure[@xml:lang='en']) then
                                                        ...
                                                        return
                                                                                                                html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader100", css:map-rend-to-class(.)), $content, ())
                                                    else
                                                        (),
                                                    if (.//supportDesc/foliation/p[@xml:lang='en']) then
                                                        ...
                                                        return
                                                                                                                html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader101", css:map-rend-to-class(.)), $content, ())
                                                    else
                                                        (),
                                                    if (.//supportDesc/condition) then
                                                        let $params := 
                                                        ...
                                                        return
                                                                                                                html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader102", css:map-rend-to-class(.)), $content, ())
                                                    else
                                                        (),
                                                    if (.//accMat/p[@xml:lang='en']) then
                                                        ...
                                                        return
                                                                                                                html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader103", css:map-rend-to-class(.)), $content, ())
                                                    else
                                                        (),
                                                    if (.//msIdentifier/idno or .//msIdentifier/collection or (.//msIdentifier/repository or .//msIdentifier/institution) or .//acquisition or .//additions) then
                                                        let $params := 
                                                        ...
                                                        return
                                                                                                                html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader104", css:map-rend-to-class(.)), $content)
                                                    else
                                                        (),
                                                    if (.//msIdentifier/idno) then
                                                        let $params := 
                                                        ...
                                                        return
                                                                                                                html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader105", css:map-rend-to-class(.)), $content, ())
                                                    else
                                                        (),
                                                    if (.//msIdentifier/collection) then
                                                        let $params := 
                                                        ...
                                                        return
                                                                                                                html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader106", css:map-rend-to-class(.)), $content, ())
                                                    else
                                                        (),
                                                    if (.//msIdentifier/repository and .//msIdentifier/institution) then
                                                        let $params := 
                                                        ...
                                                        return
                                                                                                                html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader107", css:map-rend-to-class(.)), $content, ())
                                                    else
                                                        (),
                                                    if (.//msIdentifier/repository and not(.//msIdentifier/institution)) then
                                                        let $params := 
                                                        ...
                                                        return
                                                                                                                html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader108", css:map-rend-to-class(.)), $content, ())
                                                    else
                                                        (),
                                                    if (.//msIdentifier/institution and not(.//msIdentifier/repository)) then
                                                        let $params := 
                                                        ...
                                                        return
                                                                                                                html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader109", css:map-rend-to-class(.)), $content, ())
                                                    else
                                                        (),
                                                    if (.//acquisition/p[@xml:lang='en']) then
                                                        ...
                                                        return
                                                                                                                html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader110", css:map-rend-to-class(.)), $content, ())
                                                    else
                                                        (),
                                                    if (.//additions/p[@xml:lang='en']) then
                                                        ...
                                                        return
                                                                                                                html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader111", css:map-rend-to-class(.)), $content, ())
                                                    else
                                                        (),
                                                    if (.//projectDesc/p[@xml:lang='en'] or .//principal or .//respStmt[1]/persName or .//correction/p[@xml:lang='en'] or .//hyphenation/p[@xml:lang='en']) then
                                                        ...
                                                        return
                                                                                                                html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader112", css:map-rend-to-class(.)), $content)
                                                    else
                                                        (),
                                                    if (.//projectDesc/p[@xml:lang='en']) then
                                                        ...
                                                        return
                                                                                                                html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader113", css:map-rend-to-class(.)), $content, ())
                                                    else
                                                        (),
                                                    if (.//principal) then
                                                        let $params := 
                                                        ...
                                                        return
                                                                                                                html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader114", css:map-rend-to-class(.)), $content, ())
                                                    else
                                                        (),
                                                    if (.//respStmt[1]/persName) then
                                                        let $params := 
                                                        ...
                                                        return
                                                                                                                html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader115", css:map-rend-to-class(.)), $content, ())
                                                    else
                                                        (),
                                                    if (.//correction/p[@xml:lang='en']) then
                                                        ...
                                                        return
                                                                                                                html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader116", css:map-rend-to-class(.)), $content, ())
                                                    else
                                                        (),
                                                    if (.//hyphenation/p[@xml:lang='en']) then
                                                        ...
                                                        return
                                                                                                                html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader117", css:map-rend-to-class(.)), $content, ())
                                                    else
                                                        ()
                                                )
                                                ...
                                                if ($parameters?mode='metadata-de') then
                                                    (
                                                        if (.//titleStmt/title[@xml:lang='de']) then
                                                            ...
                                                            return
                                                                                                                        html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader118", css:map-rend-to-class(.)), $content)
                                                        else
                                                            (),
                                                        if ((.//correspAction[@type='sent']/persName or .//correspAction[@type='sent']/orgName) or (.//correspAction[@type='received']/persName or .//correspAction[@type='received']/orgName)) then
                                                            let $params := 
                                                            ...
                                                            return
                                                                                                                        html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader119", css:map-rend-to-class(.)), $content)
                                                        else
                                                            (),
                                                        if (.//correspAction[@type='sent']/persName or .//correspAction[@type='sent']/orgName) then
                                                            let $params := 
                                                            ...
                                                            return
                                                                                                                        html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader120", css:map-rend-to-class(.)), $content, ())
                                                        else
                                                            (),
                                                        if (.//correspAction[@type='received']/persName or .//correspAction[@type='received']/orgName) then
                                                            let $params := 
                                                            ...
                                                            return
                                                                                                                        html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader121", css:map-rend-to-class(.)), $content, ())
                                                        else
                                                            (),
                                                        if (.//titleStmt/author/persName|.//creation/persName and not(.//correspDesc)) then
                                                            let $params := 
                                                            ...
                                                            return
                                                                                                                        html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader122", css:map-rend-to-class(.)), $content)
                                                        else
                                                            (),
                                                        if (.//history/origin/p[@xml:lang='de'] or .//creation) then
                                                            ...
                                                            return
                                                                                                                        html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader123", css:map-rend-to-class(.)), $content)
                                                        else
                                                            (),
                                                        if (.//supportDesc/extent/measure[@xml:lang='de'] or .//supportDesc/foliation/p[@xml:lang='de'] or .//supportDesc/condition/p[@xml:lang='de'] or .//accMat/p[@xml:lang='de']) then
                                                            ...
                                                            return
                                                                                                                        html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader124", css:map-rend-to-class(.)), $content)
                                                        else
                                                            (),
                                                        if (.//supportDesc/extent/measure[@xml:lang='de']) then
                                                            ...
                                                            return
                                                                                                                        html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader125", css:map-rend-to-class(.)), $content, ())
                                                        else
                                                            (),
                                                        if (.//supportDesc/foliation/p[@xml:lang='de']) then
                                                            ...
                                                            return
                                                                                                                        html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader126", css:map-rend-to-class(.)), $content, ())
                                                        else
                                                            (),
                                                        if (.//supportDesc/condition/p[@xml:lang='de']) then
                                                            ...
                                                            return
                                                                                                                        html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader127", css:map-rend-to-class(.)), $content, ())
                                                        else
                                                            (),
                                                        if (.//accMat/p[@xml:lang='de']) then
                                                            ...
                                                            return
                                                                                                                        html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader128", css:map-rend-to-class(.)), $content, ())
                                                        else
                                                            (),
                                                        if (.//msIdentifier/idno or .//msIdentifier/collection or (.//msIdentifier/repository or .//msIdentifier/institution) or .//acquisition or .//additions) then
                                                            let $params := 
                                                            ...
                                                            return
                                                                                                                        html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader129", css:map-rend-to-class(.)), $content)
                                                        else
                                                            (),
                                                        if (.//msIdentifier/idno) then
                                                            let $params := 
                                                            ...
                                                            return
                                                                                                                        html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader130", css:map-rend-to-class(.)), $content, ())
                                                        else
                                                            (),
                                                        if (.//msIdentifier/collection) then
                                                            let $params := 
                                                            ...
                                                            return
                                                                                                                        html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader131", css:map-rend-to-class(.)), $content, ())
                                                        else
                                                            (),
                                                        if (.//msIdentifier/repository and .//msIdentifier/institution) then
                                                            let $params := 
                                                            ...
                                                            return
                                                                                                                        html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader132", css:map-rend-to-class(.)), $content, ())
                                                        else
                                                            (),
                                                        if (.//msIdentifier/repository and not(.//msIdentifier/institution)) then
                                                            let $params := 
                                                            ...
                                                            return
                                                                                                                        html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader133", css:map-rend-to-class(.)), $content, ())
                                                        else
                                                            (),
                                                        if (.//msIdentifier/institution and not(.//msIdentifier/repository)) then
                                                            let $params := 
                                                            ...
                                                            return
                                                                                                                        html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader134", css:map-rend-to-class(.)), $content, ())
                                                        else
                                                            (),
                                                        if (.//acquisition/p[@xml:lang='de']) then
                                                            ...
                                                            return
                                                                                                                        html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader135", css:map-rend-to-class(.)), $content, ())
                                                        else
                                                            (),
                                                        if (.//additions/p[@xml:lang='de']) then
                                                            ...
                                                            return
                                                                                                                        html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader136", css:map-rend-to-class(.)), $content, ())
                                                        else
                                                            (),
                                                        if (.//projectDesc/p[@xml:lang='de'] or .//principal or .//respStmt[1]/persName or .//correction/p[@xml:lang='de'] or .//hyphenation/p[@xml:lang='de']) then
                                                            ...
                                                            return
                                                                                                                        html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader137", css:map-rend-to-class(.)), $content)
                                                        else
                                                            (),
                                                        if (.//projectDesc/p[@xml:lang='de']) then
                                                            ...
                                                            return
                                                                                                                        html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader138", css:map-rend-to-class(.)), $content, ())
                                                        else
                                                            (),
                                                        if (.//principal) then
                                                            let $params := 
                                                            ...
                                                            return
                                                                                                                        html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader139", css:map-rend-to-class(.)), $content, ())
                                                        else
                                                            (),
                                                        if (.//respStmt[1]/persName) then
                                                            let $params := 
                                                            ...
                                                            return
                                                                                                                        html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader140", css:map-rend-to-class(.)), $content, ())
                                                        else
                                                            (),
                                                        if (.//correction/p[@xml:lang='de']) then
                                                            ...
                                                            return
                                                                                                                        html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader141", css:map-rend-to-class(.)), $content, ())
                                                        else
                                                            (),
                                                        if (.//hyphenation/p[@xml:lang='de']) then
                                                            ...
                                                            return
                                                                                                                        html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-teiHeader142", css:map-rend-to-class(.)), $content, ())
                                                        else
                                                            ()
                                                    )
                                                    ...
                                                    if ($parameters?mode='title') then
                                                        html:inline($config, ., ("tei-teiHeader143", css:map-rend-to-class(.)), (fileDesc/titleStmt/title[1]))
                                                    else
                                                        if ($parameters?header='short') then
                                                            html:block($config, ., ("tei-teiHeader144", css:map-rend-to-class(.)), .)
                                                        else
                                                            html:metadata($config, ., ("tei-teiHeader145", css:map-rend-to-class(.)), .)
                    case element(supplied) return
                        if ($parameters?mode="corrections") then
                            (
                                if (@reason) then
                                    printcss:alternate($config, ., ("tei-supplied1", css:map-rend-to-class(.)), ., ., concat("The characters has been supplied because the text is ", @reason))
                                else
                                    (),
                                if (not(@reason)) then
                                    printcss:alternate($config, ., ("tei-supplied2", css:map-rend-to-class(.)), ., ., "The characters has been supplied")
                                else
                                    ()
                            )
                    ...
                    case element(milestone) return
                        if (@type="line") then
                            ...
                            return
                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-milestone1", css:map-rend-to-class(.)), $content)
                        else
                            html:inline($config, ., ("tei-milestone2", css:map-rend-to-class(.)), .)
                    ...
                    case element(label) return
                        if ($parameters?mode='index' and parent::event) then
                            ...
                            if ($parameters?mode='index') then
                                html:block($config, ., ("tei-label2", css:map-rend-to-class(.)), .)
                            else
                                if ($parameters?mode='list') then
                                    html:block($config, ., ("tei-label3", css:map-rend-to-class(.)), .)
                                else
                                    if (@hand and $parameters?mode="corrections") then
                                        printcss:alternate($config, ., ("tei-label4", css:map-rend-to-class(.)), ., ., id(substring-after(@hand, '#'), root($parameters?root))/p[@xml:lang="en"])
                                    else
                                        if (parent::item) then
                                            let $params := 
                                                map {
                                            ...
                                            return
                                                                                        html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-label5", css:map-rend-to-class(.)), $content)
                                        else
                                            if (parent::list) then
                                                let $params := 
                                                    map {
                                                ...
                                                return
                                                                                                html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-label6", css:map-rend-to-class(.)), $content)
                                            else
                                                $config?apply($config, ./node())
                    case element(signed) return
                        if (@hand and $parameters?mode="corrections") then
                            ...
                            return
                                                        printcss:alternate(map:merge(($config, map:entry("template", true()))), ., ("tei-signed12", css:map-rend-to-class(.)), $content, ., concat("Additions made by: ", id(substring-after(@hand, '#'), root($parameters?root))/p[@xml:lang="en"]))
                        else
                            let $params := 
                                map {
                                    "rend": if (@rend="align(center)") then 'text-align:center;' else  (if ((@rend="align(right)") or (@rend="margin(right)")) then 'text-align:right;' else     (if (@rend="align(left)") then 'text-align:left;' else         (if (@rend="indent") then 'text-indent: 15%;' else ''))),
                            ...
                            return
                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-signed13", css:map-rend-to-class(.)), $content)
                    case element(pb) return
                        html:webcomponent($config, ., ("tei-pb4", "facs", css:map-rend-to-class(.)), @n, 'pb-facs-link', map {"facs": replace(@facs, '^iiif:(.*)$', '$1'), "emit": 'transcription'})
                    case element(pc) return
                        html:inline($config, ., ("tei-pc", css:map-rend-to-class(.)), .)
                    case element(anchor) return
                        if (preceding-sibling::delSpan) then
                            html:block($config, ., ("tei-anchor1", css:map-rend-to-class(.)), "[End of the deletion]")
                        else
                    ...
                    case element(choice) return
                        if ($parameters?mode='corrections') then
                            html:inline($config, ., ("tei-choice1", css:map-rend-to-class(.)), abbr[1])
                        else
                            if ($parameters?mode="original" or $parameters?mode="entities") then
                                html:inline($config, ., ("tei-choice2", css:map-rend-to-class(.)), expan[1])
                            else
                                if (unclear) then
                                    html:inline($config, ., ("tei-choice3", css:map-rend-to-class(.)), unclear[1])
                                else
                                    if (sic and corr) then
                                        printcss:alternate($config, ., ("tei-choice6", css:map-rend-to-class(.)), ., corr[1], sic[1])
                                    else
                    ...
                    case element(hi) return
                        if (@rend="underline" and @n="2") then
                            html:inline($config, ., ("tei-hi7", css:map-rend-to-class(.)), .)
                        else
                            if (@rend="superscript underline") then
                                html:inline($config, ., ("tei-hi8", css:map-rend-to-class(.)), .)
                            else
                                if (@rend="superscript") then
                                    html:inline($config, ., ("tei-hi9", css:map-rend-to-class(.)), .)
                                else
                                    if (@rend="align(center)") then
                                        html:inline($config, ., ("tei-hi10", css:map-rend-to-class(.)), .)
                                    else
                                        if (@rend="latin") then
                                            html:inline($config, ., ("tei-hi11", css:map-rend-to-class(.)), .)
                                        else
                                            if (@rend='underline') then
                                                html:inline($config, ., ("tei-hi12", css:map-rend-to-class(.)), .)
                                            else
                                                $config?apply($config, ./node())
                        ...
                        if ($parameters?mode="original") then
                            (
                                if (@type="foliation") then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-note14", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (@resp) then
                                    printcss:note($config, ., ("tei-note15", css:map-rend-to-class(.)), if (p[@xml:lang="en"]) then (p[@xml:lang="en"]) else ., (), ())
                                else
                                    (),
                                if (@type="gloss") then
                                    printcss:note($config, ., ("tei-note16", css:map-rend-to-class(.)), ., (), ())
                                else
                                    (),
                                if (@hand and not(@type="foliation")) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-note17", css:map-rend-to-class(.)), $content)
                                else
                                    ()
                            )
                            ...
                            if ($parameters?mode="entities") then
                                (
                                    if (@type="foliation") then
                                        ...
                                        return
                                                                                html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-note18", css:map-rend-to-class(.)), $content)
                                    else
                                        (),
                                    if (@resp or @type="gloss") then
                                        html:omit($config, ., ("tei-note19", css:map-rend-to-class(.)), .)
                                    else
                                        (),
                                    if (@hand and not(@type="foliation")) then
                                        let $params := 
                                        ...
                                        return
                                                                                html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-note20", css:map-rend-to-class(.)), $content)
                                    else
                                        ()
                                )
                                ...
                                if ($parameters?mode="corrections") then
                                    (
                                        if (@hand) then
                                            printcss:alternate($config, ., ("tei-note21", css:map-rend-to-class(.)), ., ., concat("Additions made by: ", id(substring-after(@hand, '#'), root($parameters?root))/p[@xml:lang="en"]))
                                        else
                                            (),
                                        if (@type="foliation" and not(@hand)) then
                                            ...
                                            return
                                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-note22", css:map-rend-to-class(.)), $content)
                                        else
                                            (),
                                        if (@resp or @type="gloss") then
                                            html:omit($config, ., ("tei-note23", css:map-rend-to-class(.)), .)
                                        else
                                            ()
                                    )
                    ...
                    case element(dateline) return
                        if (@rend="align(right)") then
                            html:block($config, ., ("tei-dateline5", css:map-rend-to-class(.)), .)
                        else
                            if (@rend="align(center)") then
                                html:block($config, ., ("tei-dateline6", css:map-rend-to-class(.)), .)
                            else
                                if (@rend="align(left)") then
                                    html:block($config, ., ("tei-dateline7", css:map-rend-to-class(.)), .)
                                else
                                    if (@rend="indent") then
                                        html:block($config, ., ("tei-dateline8", css:map-rend-to-class(.)), .)
                                    else
                                        html:inline($config, ., ("tei-dateline9", css:map-rend-to-class(.)), .)
                    case element(back) return
                        html:block($config, ., ("tei-back", css:map-rend-to-class(.)), .)
                    case element(del) return
                        if ($parameters?mode='entities' or $parameters?mode='original') then
                            html:omit($config, ., ("tei-del3", css:map-rend-to-class(.)), .)
                        else
                            if (@rend='overwritten' and $parameters?mode='corrections') then
                                ...
                                if (@rend='strikethrough' and $parameters?mode='corrections') then
                                    html:inline($config, ., ("tei-del6", css:map-rend-to-class(.)), .)
                                else
                                    $config?apply($config, ./node())
                    case element(trailer) return
                        ...
                        return
                                                html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-trailer", css:map-rend-to-class(.)), $content)
                    ...
                    case element(revisionDesc) return
                        if ($parameters?header='short' and @status) then
                            ...
                            return
                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-revisionDesc1", "header-short", css:map-rend-to-class(.)), $content)
                        else
                            html:omit($config, ., ("tei-revisionDesc2", css:map-rend-to-class(.)), .)
                    ...
                    case element(subst) return
                        if ((del[@rend="overwritten"] and add) and $parameters?mode="corrections") then
                            printcss:alternate($config, ., ("tei-subst3", css:map-rend-to-class(.)), ., add, concat("This text has been overwritten: ", del))
                        else
                            if (del[@rend="overwritten"] and add) then
                                printcss:alternate($config, ., ("tei-subst4", css:map-rend-to-class(.)), ., add, del)
                            else
                                $config?apply($config, ./node())
                    ...
                    case element(opener) return
                        html:block($config, ., ("tei-opener4", css:map-rend-to-class(.)), .)
                    case element(speaker) return
                        if (@rend="underline") then
                            html:inline($config, ., ("tei-speaker1", css:map-rend-to-class(.)), .)
                        else
                            html:block($config, ., ("tei-speaker2", css:map-rend-to-class(.)), .)
                    ...
                    case element(rs) return
                        if ($parameters?mode="facets" and @type="bi_place") then
                            html:omit($config, ., ("tei-rs1", css:map-rend-to-class(.)), .)
                        else
                            if ($parameters?mode="entities" and @type="bi_place" and id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/bi/indexes/Ortsindex.xml"))/location/geo) then
                                html:webcomponent($config, ., ("tei-rs2", css:map-rend-to-class(.)), ., 'pb-geolocation', map {"longitude": tokenize(id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/bi/indexes/Ortsindex.xml"))/location/geo, ' ')[2], "latitude": tokenize(id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/bi/indexes/Ortsindex.xml"))/location/geo, ' ')[1], "label": id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/bi/indexes/Ortsindex.xml"))/placeName, "key": substring-after(@ref, '#'), "scroll": true(), "emit": 'transcription'})
                            else
                                if ($parameters?mode='facets' and @type="tgb") then
                                    html:webcomponent($config, ., ("tei-rs3", css:map-rend-to-class(.)), if (@type="tgb") then id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/rochlitz/index/indices.xml")) else '', 'pb-highlight', map {"key": substring-after(@ref, '#'), "subscribe": 'letter', "emit": 'facets'})
                                else
                                    if ($parameters?mode='entities' and @type="tgb" and id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/rochlitz/index/indices.xml"))) then
                                        ...
                                        if ($parameters?mode='facets' and (@type="bi_org" or @type="pec_org")) then
                                            ...
                                            if ($parameters?mode='entities' and (@type="bi_org" and id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/bi/indexes/Organisationsindex_Gruppenindex.xml"))) or (@type="pec_org" and id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/pec/index/Index_organizations.xml")))) then
                                                html:webcomponent($config, ., ("tei-rs6", css:map-rend-to-class(.)), ., 'pb-highlight', map {"key": substring-after(@ref, '#'), "scroll": true(), "emit": 'letter'})
                                            else
                                                if ($parameters?mode='facets' and (@type="bi_title" or @type="pec_title")) then
                                                    ...
                                                    if ($parameters?mode='entities' and (@type="bi_title" and id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/bi/indexes/Werkindex.xml"))) or (@type="pec_title" and id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/pec/index/Index_biblio.xml"))) or (@type="ehri_title" and id(substring-after(@ref, '#'), root($parameters?root)))) then
                                                        html:webcomponent($config, ., ("tei-rs8", css:map-rend-to-class(.)), ., 'pb-highlight', map {"key": substring-after(@ref, '#'), "scroll": true(), "emit": 'letter'})
                                                    else
                                                        if ($parameters?mode='facets' and (@type="bi_person" or @type="pec_person")) then
                                                            ...
                                                            if ($parameters?mode='entities' and ((@type="bi_person" and id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/bi/indexes/Personenindex.xml"))) or (@type="pec_person" and id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/pec/index/Index_person.xml"))) or (@type="ehri_person" and id(substring-after(@ref, '#'), root($parameters?root))))) then
                                                                html:webcomponent($config, ., ("tei-rs10", css:map-rend-to-class(.)), ., 'pb-highlight', map {"key": substring-after(@ref, '#'), "scroll": true(), "emit": 'letter'})
                                                            else
                                                                $config?apply($config, ./node())
                    ...
                    case element(profileDesc) return
                        if ($parameters?mode="corresp" and child::correspContext) then
                            ...
                            if ($parameters?header='short' and child::abstract) then
                                html:block($config, ., ("tei-profileDesc2", css:map-rend-to-class(.)), abstract/p)
                            else
                                if ($parameters?header='short' and child::correspDesc/correspAction[@type="sent"]/placeName) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-profileDesc3", "header-short", css:map-rend-to-class(.)), $content)
                                else
                                    html:omit($config, ., ("tei-profileDesc4", css:map-rend-to-class(.)), .)
                    case element(email) return
                        html:inline($config, ., ("tei-email", css:map-rend-to-class(.)), .)
                    case element(text) return
                        if ($parameters?mode='list') then
                            html:block($config, ., ("tei-text1", css:map-rend-to-class(.)), /body)
                        else
                        ...
                        if (@ana) then
                            (
                                if ($parameters?mode='corrections') then
                                    ...
                                    (),
                                if ($parameters?mode="original" or $parameters?mode='entities') then
                                    html:inline($config, ., ("tei-abbr2", css:map-rend-to-class(.)), substring-after(@ana, "#"))
                                else
                                    ()
                            )
                    ...
                    case element(table) return
                        if (@rend="align(center)") then
                            html:table($config, ., ("tei-table1", css:map-rend-to-class(.)), .)
                        else
                            html:table($config, ., ("tei-table2", css:map-rend-to-class(.)), .)
                    ...
                    case element(licence) return
                        if (@target) then
                            ...
                            return
                                                        html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-licence1", css:map-rend-to-class(.)), $content)
                        else
                            html:block($config, ., ("tei-licence2", css:map-rend-to-class(.)), .)
                    ...
                    case element(address) return
                        if (@rend='align(right)') then
                            html:block($config, ., ("tei-address1", css:map-rend-to-class(.)), .)
                        else
                            if (@rend='align(left)') then
                                html:block($config, ., ("tei-address2", css:map-rend-to-class(.)), .)
                            else
                                if (@rend='align(center)') then
                                    html:block($config, ., ("tei-address3", css:map-rend-to-class(.)), .)
                                else
                                    (: More than one model without predicate found for ident address. Choosing first one. :)
                                    html:block($config, ., ("tei-address4", css:map-rend-to-class(.)), .)
                    ...
                    case element(closer) return
                        ...
                        return
                                                html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-closer3", css:map-rend-to-class(.)), $content)
                    ...
                    case element(list) return
                        ...
                        return
                                                html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-list", css:map-rend-to-class(.)), $content, ())
                    case element(p) return
                        if (parent::event) then
                            html:inline($config, ., ("tei-p16", css:map-rend-to-class(.)), .)
                        else
                            if ($parameters?mode="index" or $parameters?mode="facets") then
                                html:omit($config, ., ("tei-p17", css:map-rend-to-class(.)), .)
                            else
                                if (@hand and $parameters?mode="corrections") then
                                    printcss:alternate($config, ., ("tei-p18", css:map-rend-to-class(.)), ., ., id(substring-after(@hand, '#'), root($parameters?root))/p[@xml:lang="en"])
                                else
                                    if ($parameters?mode='metadata-fr' or $parameters?mode='metadata-en' or $parameters?mode='metadata-de' or parent::note or parent::abstract or parent::handNote or parent::postscript) then
                                        html:inline($config, ., ("tei-p19", css:map-rend-to-class(.)), .)
                                    else
                                        let $params := 
                                            map {
                                                "rend": if (@rend="align(center)") then 'text-align:center;' else  (if ((@rend="align(right)") or (@rend="margin(right)")) then 'text-align:right;' else     (if (@rend="align(left)") then 'text-align:left;' else         (if (@rend="indent") then 'text-indent: 15%;' else ''))),
                                        ...
                                        return
                                                                                html:paragraph(map:merge(($config, map:entry("template", true()))), ., ("tei-p20", css:map-rend-to-class(.)), $content)
                    ...
                    case element(lb) return
                        if (preceding-sibling::item) then
                            html:break($config, ., ("tei-lb1", css:map-rend-to-class(.)), ., 'line', @n)
                        else
                            if (not(@break="no") and ($parameters?mode="original" or $parameters?mode="entities")) then
                                html:inline($config, ., ("tei-lb2", css:map-rend-to-class(.)), " ")
                            else
                                if ($parameters?mode='corrections') then
                                    html:break($config, ., css:get-rendition(., ("tei-lb4", css:map-rend-to-class(.))), ., 'line', @n)
                                else
                                    $config?apply($config, ./node())
                    ...
                    case element(name) return
                        if ($parameters?mode='index') then
                            html:block($config, ., ("tei-name1", css:map-rend-to-class(.)), .)
                        else
                            html:inline($config, ., ("tei-name2", css:map-rend-to-class(.)), .)
                    case element(front) return
                        html:block($config, ., ("tei-front", css:map-rend-to-class(.)), .)
                    case element(lg) return
                        html:block($config, ., ("tei-lg", css:map-rend-to-class(.)), .)
                    case element(publicationStmt) return
                        html:inline($config, ., ("tei-publicationStmt", css:map-rend-to-class(.)), .)
                    ...
                    case element(postscript) return
                        ...
                        return
                                                html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-postscript", css:map-rend-to-class(.)), $content)
                        ...
                        if ($parameters?mode='facets') then
                            (
                                if (descendant::persName) then
                                    html:heading($config, ., ("tei-div1", css:map-rend-to-class(.)), 'Persons', 2)
                                else
                                    (),
                                html:block($config, ., ("tei-div2", css:map-rend-to-class(.)), for $n in .//persName group by $ref := $n/@ref order by $ref return $n[1]),
                                if (descendant::orgName) then
                                    html:heading($config, ., ("tei-div3", css:map-rend-to-class(.)), 'Organisations/Groups', 2)
                                else
                                    (),
                                html:block($config, ., ("tei-div4", css:map-rend-to-class(.)), for $n in .//orgName group by $ref := $n/@ref order by $ref return $n[1]),
                                if (descendant::title[@ref]) then
                                    html:heading($config, ., ("tei-div5", css:map-rend-to-class(.)), "Bibliography", 2)
                                else
                                    (),
                                html:block($config, ., ("tei-div6", css:map-rend-to-class(.)), for $n in .//title[@ref] group by $ref := $n/@ref order by $ref return $n[1]),
                                if (descendant::rs) then
                                    html:heading($config, ., ("tei-div7", css:map-rend-to-class(.)), "Undefined references", 2)
                                else
                                    (),
                                html:block($config, ., ("tei-div8", css:map-rend-to-class(.)), for $n in .//rs group by $ref := $n/@ref order by $ref return $n[1]),
                                if (descendant::term) then
                                    html:heading($config, ., ("tei-div9", css:map-rend-to-class(.)), "Terms", 2)
                                else
                                    (),
                                html:block($config, ., ("tei-div10", css:map-rend-to-class(.)), for $n in .//term group by $ref := $n/@ref order by $ref return $n[1])
                            )

                        else
                            if ($parameters?mode='facets' and parent::body) then
                                (: facets rendition :)
                                html:block($config, ., ("tei-div15", css:map-rend-to-class(.)), .)
                            else
                                if (@type='title_page') then
                                    html:block($config, ., ("tei-div16", css:map-rend-to-class(.)), .)
                                else
                                    if (parent::body) then
                                        html:section($config, ., ("tei-div17", css:map-rend-to-class(.)), .)
                                    else
                                        html:block($config, ., ("tei-div18", css:map-rend-to-class(.)), .)
                    ...
                    case element(ref) return
                        if (parent::bibl) then
                            ...
                            return
                                                        html:listItem(map:merge(($config, map:entry("template", true()))), ., ("tei-ref1", css:map-rend-to-class(.)), $content, ())
                        else
                            if (id(substring-after(@target, '#'), root($parameters?root))/div[@type="chapter"]) then
                                html:omit($config, ., ("tei-ref2", css:map-rend-to-class(.)), .)
                            else
                                if (not(@target)) then
                    ...
                    case element(add) return
                        if (@hand and $parameters?mode='corrections') then
                            ...
                            return
                                                        printcss:alternate(map:merge(($config, map:entry("template", true()))), ., ("tei-add3", css:map-rend-to-class(.)), $content, ., concat("Additions made by: ", id(substring-after(@hand, '#'), root($parameters?root))/p[@xml:lang="en"]))
                        else
                            if ($parameters?mode='corrections') then
                                (: for diplomatic view :)
                                printcss:alternate($config, ., ("tei-add4", css:map-rend-to-class(.)), ., ., "Additions made by the major hand")
                            else
                                (: default model :)
                                html:inline($config, ., ("tei-add5", css:map-rend-to-class(.)), .)
                    case element(docDate) return
                        html:inline($config, ., ("tei-docDate", css:map-rend-to-class(.)), .)
                    case element(head) return
                        if (@hand and $parameters?mode="corrections") then
                            printcss:alternate($config, ., ("tei-head8", css:map-rend-to-class(.)), ., ., concat("Additions made by: ", id(substring-after(@hand, '#'), root($parameters?root))/p[@xml:lang="en"]))
                        else
                            if ($parameters?header='short') then
                                html:inline($config, ., ("tei-head9", css:map-rend-to-class(.)), replace(string-join(.//text()[not(parent::ref)]), '^(.*?)[^\w]*$', '$1'))
                            else
                                if (child::dateline) then
                                    html:block($config, ., ("tei-head10", css:map-rend-to-class(.)), .)
                                else
                                    if (parent::figure) then
                                        html:block($config, ., ("tei-head11", css:map-rend-to-class(.)), .)
                                    else
                                        if (parent::list) then
                                            html:block($config, ., ("tei-head12", css:map-rend-to-class(.)), .)
                                        else
                                            if (parent::table) then
                                                html:block($config, ., ("tei-head13", css:map-rend-to-class(.)), .)
                                            else
                                                if (parent::lg) then
                                                    html:block($config, ., ("tei-head14", css:map-rend-to-class(.)), .)
                                                else
                                                    if (parent::div[@type='transcription'] or parent::div[@type='letter'] or parent::div[@type='annex']) then
                                                        html:block($config, ., ("tei-head15", css:map-rend-to-class(.)), .)
                                                    else
                                                        if (parent::div) then
                                                            html:heading($config, ., ("tei-head16", css:map-rend-to-class(.)), ., count(ancestor::div))
                                                        else
                                                            html:block($config, ., ("tei-head17", css:map-rend-to-class(.)), .)
                    ...
                    case element(bibl) return
                        if (parent::person or parent::place) then
                            html:inline($config, ., ("tei-bibl1", css:map-rend-to-class(.)), ref)
                        else
                    ...
                    case element(salute) return
                        if (@rend="align(right)") then
                            html:block($config, ., ("tei-salute9", css:map-rend-to-class(.)), .)
                        else
                            if (@rend="align(center)") then
                                html:block($config, ., ("tei-salute10", css:map-rend-to-class(.)), .)
                            else
                                if (@rend="align(left)") then
                                    html:block($config, ., ("tei-salute11", css:map-rend-to-class(.)), .)
                                else
                                    if (@rend="indent") then
                                        html:block($config, ., ("tei-salute12", css:map-rend-to-class(.)), .)
                                    else
                                        if (parent::opener or parent::closer) then
                                            html:inline($config, ., ("tei-salute13", css:map-rend-to-class(.)), .)
                                        else
                                            $config?apply($config, ./node())
                    case element(unclear) return
                        if ($parameters?mode="corrections") then
                            (
                                if (@reason) then
                                    printcss:alternate($config, ., ("tei-unclear1", css:map-rend-to-class(.)), ., ., concat("The characters are unclear because the text is ", @reason))
                                else
                                    (),
                                if (not(@reason)) then
                                    printcss:alternate($config, ., ("tei-unclear2", css:map-rend-to-class(.)), ., ., "Unclear character(s)")
                                else
                                    ()
                            )
                    ...
                    case element(argument) return
                        (: default rendition :)
                        html:block($config, ., ("tei-argument2", css:map-rend-to-class(.)), .)
                    case element(date) return
                        if (text()) then
                            ...
                            if (@when) then
                                ...
                                return
                                                                html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-date2", css:map-rend-to-class(.)), $content)
                            else
                                if (@when-iso) then
                                    html:inline($config, ., ("tei-date3", css:map-rend-to-class(.)), format-date(@when-iso, '[D10] [MNn] [Y]', 'en', 'AD', 'GB'))
                                else
                                    if (@when-iso) then
                                        let $params := 
                                            map {
                                        ...
                                        return
                                                                                html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-date4", css:map-rend-to-class(.)), $content)
                                    else
                                        if (parent::affiliation) then
                                            ...
                                            return
                                                                                        html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-date5", css:map-rend-to-class(.)), $content)
                                        else
                                            $config?apply($config, ./node())
                    case element(title) return
                        if ($parameters?mode='facets') then
                            ...
                            if ($parameters?mode='entities' and (@type="bi" and id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/bi/indexes/Werkindex.xml"))) or (@type="pec" and id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/pec/index/Index_biblio.xml"))) or (@type="ehri" and id(substring-after(@ref, '#'), root($parameters?root)))) then
                                html:webcomponent($config, ., ("tei-title2", css:map-rend-to-class(.)), ., 'pb-highlight', map {"key": substring-after(@ref, '#'), "scroll": true(), "emit": 'letter'})
                            else
                                if (@rend="align(right) underline") then
                                    html:block($config, ., ("tei-title18", css:map-rend-to-class(.)), .)
                                else
                                    if (@rend="align(right)") then
                                        html:block($config, ., ("tei-title19", css:map-rend-to-class(.)), .)
                                    else
                                        if (@rend="align(center) underline") then
                                            html:block($config, ., ("tei-title20", css:map-rend-to-class(.)), .)
                                        else
                                            if (@rend="align(center)") then
                                                html:block($config, ., ("tei-title21", css:map-rend-to-class(.)), .)
                                            else
                                                if ($parameters?mode='metadata-fr') then
                                                    html:inline($config, ., ("tei-title22", css:map-rend-to-class(.)), .)
                                                else
                                                    if ($parameters?mode='metadata-en') then
                                                        html:inline($config, ., ("tei-title23", css:map-rend-to-class(.)), .)
                                                    else
                                                        if ($parameters?mode='metadata-de') then
                                                            html:inline($config, ., ("tei-title24", css:map-rend-to-class(.)), .)
                                                        else
                                                            if ($parameters?header='short') then
                                                                html:heading($config, ., ("tei-title25", css:map-rend-to-class(.)), ., 5)
                                                            else
                                                                if (parent::titleStmt/parent::fileDesc) then
                                                                    (
                                                                        if (preceding-sibling::title) then
                                                                            html:text($config, ., ("tei-title26", css:map-rend-to-class(.)), ' — ')
                                                                        else
                                                                            (),
                                                                        html:inline($config, ., ("tei-title27", css:map-rend-to-class(.)), .)
                                                                    )

                                                                else
                                                                    if (not(@level)) then
                                                                        html:inline($config, ., ("tei-title28", css:map-rend-to-class(.)), .)
                                                                    else
                                                                        if (@level='m' or not(@level)) then
                                                                            (
                                                                                html:inline($config, ., ("tei-title29", css:map-rend-to-class(.)), .),
                                                                                if (ancestor::biblFull) then
                                                                                    html:text($config, ., ("tei-title30", css:map-rend-to-class(.)), ', ')
                                                                                else
                                                                                    ()
                                                                            )
                                                                            ...
                                                                            if (@level='s' or @level='j') then
                                                                                (
                                                                                    html:inline($config, ., ("tei-title31", css:map-rend-to-class(.)), .),
                                                                                    if (following-sibling::* and     (  ancestor::biblFull)) then
                                                                                        html:text($config, ., ("tei-title32", css:map-rend-to-class(.)), ', ')
                                                                                    else
                                                                                        ()
                                                                                )
                                                                                ...
                                                                                if (@level='u' or @level='a') then
                                                                                    (
                                                                                        html:inline($config, ., ("tei-title33", css:map-rend-to-class(.)), .),
                                                                                        if (following-sibling::* and     (    ancestor::biblFull)) then
                                                                                            html:text($config, ., ("tei-title34", css:map-rend-to-class(.)), '. ')
                                                                                        else
                                                                                            ()
                                                                                    )
                    ...
                    case element(cit) return
                        if (child::quote and child::bibl ) then
                            ...
                            return
                                                        html:cit(map:merge(($config, map:entry("template", true()))), ., ("tei-cit1", css:map-rend-to-class(.)), $content, ())
                        else
                            if (child::quote and child::bibl) then
                                (: Insert citation :)
                                html:cit($config, ., ("tei-cit2", css:map-rend-to-class(.)), ., ())
                            else
                                $config?apply($config, ./node())
                    case element(titleStmt) return
                        if ($parameters?mode='metadata-fr') then
                            html:block($config, ., ("tei-titleStmt1", css:map-rend-to-class(.)), .)
                        else
                            if ($parameters?mode='metadata-en') then
                                html:block($config, ., ("tei-titleStmt2", css:map-rend-to-class(.)), .)
                            else
                                if ($parameters?mode='metadata-de') then
                                    html:block($config, ., ("tei-titleStmt3", css:map-rend-to-class(.)), .)
                                else
                                    if ($parameters?mode='title') then
                                        html:heading($config, ., ("tei-titleStmt6", css:map-rend-to-class(.)), if (title[@xml:lang="en"]) then (title[@xml:lang="en"]) else (title[1]), 5)
                                    else
                                        if ($parameters?header='short') then
                                            (
                                                html:link($config, ., ("tei-titleStmt7", css:map-rend-to-class(.)), if (title[@xml:lang="en"]) then title[@xml:lang="en"] else title[1], $parameters?doc, (), map {}),
                                                if (title[@xml:lang="de"]) then
                                                    html:block($config, ., ("tei-titleStmt8", css:map-rend-to-class(.)), title[@xml:lang="de"])
                                                else
                                                    (),
                                                if (not(title[@xml:lang="de"])) then
                                                    html:block($config, ., ("tei-titleStmt9", css:map-rend-to-class(.)), title[@xml:lang="fr"])
                                                else
                                                    (),
                                                if (author) then
                                                    let $params := 
                                                    ...
                                                    return
                                                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-titleStmt10", css:map-rend-to-class(.)), $content)
                                                else
                                                    (),
                                                html:block($config, ., ("tei-titleStmt11", css:map-rend-to-class(.)), author/affiliation/orgName)
                                            )

                                        else
                                            html:block($config, ., ("tei-titleStmt12", css:map-rend-to-class(.)), .)
                        ...
                        if ($parameters?mode='list') then
                            (
                                if (descendant::listEvent) then
                                    html:heading($config, ., ("tei-body4", css:map-rend-to-class(.)), "EVENTS", ())
                                else
                                    (),
                                if (descendant::listEvent) then
                                    html:block($config, ., ("tei-body5", css:map-rend-to-class(.)), for $n in .//listEvent/event group by $ref := $n/label order by $ref return $n)
                                else
                                    (),
                                if (descendant::listPerson/@xml:id) then
                                    html:heading($config, ., ("tei-body6", css:map-rend-to-class(.)), upper-case(listPerson/@xml:id), ())
                                else
                                    (),
                                if (descendant::listPlace/@xml:id) then
                                    html:heading($config, ., ("tei-body7", css:map-rend-to-class(.)), upper-case(listPlace/@xml:id), ())
                                else
                                    (),
                                if (.//place[@type=('archeological_site')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body8", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('boulevard')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body9", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('building')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body10", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('cabaret')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body11", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('camp')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body12", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('canal')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body13", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('canton')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body14", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('castel')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body15", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('castle')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body16", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('cathedral')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body17", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('ccuntry')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body18", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('church')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body19", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('circus')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body20", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('city')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body21", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('college')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body22", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('continent')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body23", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('country')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body24", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('department')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body25", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('district')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body26", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('duchy')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body27", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('embassy')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body28", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('empire')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body29", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('forest')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body30", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('fort')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body31", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('gulf')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body32", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('hamlet')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body33", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('hill')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body34", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('hotel')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body35", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('house')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body36", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('island')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body37", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('lake')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body38", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('location')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body39", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('mansion')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body40", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('monastery')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body41", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('monument')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body42", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('mountain')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body43", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('mountains')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body44", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('municipality')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body45", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('museum')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body46", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('ocean')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body47", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('opera')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body48", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('park')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body49", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('pass')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body50", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('peninsula')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body51", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('place')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body52", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('plain')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body53", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('point')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body54", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('port')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body55", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('quarter')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body56", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('region')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body57", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('river')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body58", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('sea')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body59", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('settlement')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body60", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('square')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body61", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('state')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body62", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('station')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body63", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('steam')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body64", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('strait')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body65", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('stream')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body66", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('street')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body67", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('theater')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body68", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('thoroughfare')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body69", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('town')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body70", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('townhall')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body71", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('university')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body72", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('upland')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body73", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('valley')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body74", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[@type=('venue')]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body75", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (.//place[not(@type)]) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-body76", css:map-rend-to-class(.)), $content)
                                else
                                    ()
                            )
                            ...
                            if ($parameters?mode='index') then
                                (
                                    html:block($config, ., ("tei-body77", css:map-rend-to-class(.)), for $n in .//listEvent/event group by $ref := $n/label order by $ref return $n),
                                    ...
                                    html:block($config, ., ("tei-body79", css:map-rend-to-class(.)), for $n in .//person group by $ref := $n/persName[1] order by $ref return $n),
                                    html:block($config, ., ("tei-body80", css:map-rend-to-class(.)), for $n in .//org group by $ref := $n/orgName[1] order by $ref return $n),
                                    html:block($config, ., ("tei-body81", css:map-rend-to-class(.)), for $n in .//biblStruct group by $ref := $n order by $ref return $n),
                                    html:block($config, ., ("tei-body82", css:map-rend-to-class(.)), for $n in .//item group by $ref := $n/(name[1]|label[1]) order by $ref return $n)
                                )

                            else
                                (
                                    html:index($config, ., ("tei-body83", css:map-rend-to-class(.)), 'toc', .),
                                    html:block($config, ., ("tei-body84", css:map-rend-to-class(.)), .)
                                )
                    ...
                    case element(fw) return
                        if (@type='letterhead' and @place="top(right)") then
                            ...
                            return
                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-fw1", css:map-rend-to-class(.)), $content)
                        else
                            if (@type='letterhead' and @place="top(center)") then
                                ...
                                if (@type='letterhead') then
                                    ...
                                    if (ancestor::opener or ancestor::div) then
                                        html:inline($config, ., ("tei-fw4", css:map-rend-to-class(.)), .)
                                    else
                                        html:block($config, ., ("tei-fw5", css:map-rend-to-class(.)), .)
                    case element(encodingDesc) return
                        html:omit($config, ., ("tei-encodingDesc", css:map-rend-to-class(.)), .)
                    case element(addrLine) return
                        if (@rend="align(right)") then
                            html:block($config, ., ("tei-addrLine4", css:map-rend-to-class(.)), .)
                        else
                            if (@rend="align(center)") then
                                html:block($config, ., ("tei-addrLine5", css:map-rend-to-class(.)), .)
                            else
                                if (@rend="align(left)") then
                                    html:block($config, ., ("tei-addrLine6", css:map-rend-to-class(.)), .)
                                else
                                    if (@rend="indent") then
                                        html:block($config, ., ("tei-addrLine7", css:map-rend-to-class(.)), .)
                                    else
                                        html:block($config, ., ("tei-addrLine8", css:map-rend-to-class(.)), .)
                        ...
                        if ($parameters?mode='original' or $parameters?mode='entities') then
                            ...
                            if (desc and $parameters?mode='corrections') then
                                ...
                                if (@extent and $parameters?mode='corrections') then
                                    printcss:alternate($config, ., ("tei-gap6", css:map-rend-to-class(.)), ., @extent, "This is a gap in the text")
                                else
                                    if (not(@extent) and $parameters?mode='corrections') then
                                        printcss:alternate($config, ., ("tei-gap7", css:map-rend-to-class(.)), ., "[[...]]", "This is a gap in the text")
                                    else
                                        $config?apply($config, ./node())
                    case element(quote) return
                        if (ancestor::p) then
                            ...
                            return
                                                        html:inline(map:merge(($config, map:entry("template", true()))), ., css:get-rendition(., ("tei-quote1", css:map-rend-to-class(.))), $content)
                        else
                            (: If it is inside a paragraph then it is inline, otherwise it is block level :)
                            let $params := 
                                map {
                            ...
                            return
                                                        html:block(map:merge(($config, map:entry("template", true()))), ., css:get-rendition(., ("tei-quote2", css:map-rend-to-class(.))), $content)
                        ...
                        if (parent::education or parent::affiliation) then
                            ...
                            if ((parent::desc or parent::persName) and ancestor::org) then
                                ...
                                if (ancestor::person) then
                                    html:block($config, ., ("tei-persName3", css:map-rend-to-class(.)), .)
                                else
                                    if (($parameters?mode="index" or $parameters?mode="facets") and ancestor::org) then
                                        ...
                                        if ($parameters?mode='facets') then
                                            ...
                                            if ($parameters?mode='entities' and ((@type="bi" and id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/bi/indexes/Personenindex.xml"))) or (@type="pec" and id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/pec/index/Index_person.xml"))) or (@type="tgb" and id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/rochlitz/index/indices.xml"))) or (@type="ehri" and id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/ehri/index/EHRI_index_persons.xml"))))) then
                                                html:webcomponent($config, ., ("tei-persName6", css:map-rend-to-class(.)), ., 'pb-highlight', map {"key": substring-after(@ref, '#'), "scroll": true(), "emit": 'letter'})
                                            else
                                                $config?apply($config, ./node())
                        ...
                        if ($parameters?mode='index') then
                            (
                                if (not(child::idno)) then
                                    ...
                                    return
                                                                        html:webcomponent(map:merge(($config, map:entry("template", true()))), ., ("tei-person1", css:map-rend-to-class(.)), $content, 'pb-highlight', map {"key": @xml:id, "subscribe": 'letter', "emit": 'index'})
                                else
                                    (),
                                if (child::idno) then
                                    let $params := 
                                    ...
                                    return
                                                                        html:webcomponent(map:merge(($config, map:entry("template", true()))), ., ("tei-person2", css:map-rend-to-class(.)), $content, 'pb-highlight', map {"key": @xml:id, "subscribe": 'letter', "emit": 'index', "viaf": idno})
                                else
                                    (),
                                if (child::persName) then
                                    html:block($config, ., ("tei-person3", css:map-rend-to-class(.)), persName except persName[1])
                                else
                                    (),
                                if (child::note) then
                                    html:block($config, ., ("tei-person4", css:map-rend-to-class(.)), note/p)
                                else
                                    (),
                                if (child::birth) then
                                    let $params := 
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-person5", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (child::death) then
                                    let $params := 
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-person6", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (child::nationality) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-person7", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (child::sex) then
                                    let $params := 
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-person8", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (child::occupation) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-person9", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (child::education) then
                                    html:block($config, ., ("tei-person10", css:map-rend-to-class(.)), education)
                                else
                                    (),
                                if (child::affiliation) then
                                    html:block($config, ., ("tei-person11", css:map-rend-to-class(.)), affiliation)
                                else
                                    (),
                                if (child::event) then
                                    html:block($config, ., ("tei-person12", css:map-rend-to-class(.)), event)
                                else
                                    (),
                                if (child::bibl) then
                                    html:block($config, ., ("tei-person13", css:map-rend-to-class(.)), bibl)
                                else
                                    ()
                            )
                            ...
                            if ($parameters?mode='facets') then
                                (
                                    if (not(child::idno)) then
                                        ...
                                        return
                                                                                html:webcomponent(map:merge(($config, map:entry("template", true()))), ., ("tei-person14", css:map-rend-to-class(.)), $content, 'pb-highlight', map {"key": @xml:id, "subscribe": 'letter', "emit": 'index'})
                                    else
                                        (),
                                    if (child::idno) then
                                        let $params := 
                                        ...
                                        return
                                                                                html:webcomponent(map:merge(($config, map:entry("template", true()))), ., ("tei-person15", css:map-rend-to-class(.)), $content, 'pb-highlight', map {"key": @xml:id, "subscribe": 'letter', "emit": 'index', "viaf": idno})
                                    else
                                        (),
                                    if (child::note) then
                                        html:block($config, ., ("tei-person16", css:map-rend-to-class(.)), note/p)
                                    else
                                        (),
                                    if (child::birth) then
                                        let $params := 
                                        ...
                                        return
                                                                                html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-person17", css:map-rend-to-class(.)), $content)
                                    else
                                        (),
                                    if (child::death) then
                                        let $params := 
                                        ...
                                        return
                                                                                html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-person18", css:map-rend-to-class(.)), $content)
                                    else
                                        (),
                                    if (child::nationality) then
                                        let $params := 
                                        ...
                                        return
                                                                                html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-person19", css:map-rend-to-class(.)), $content)
                                    else
                                        (),
                                    if (child::sex) then
                                        let $params := 
                                        ...
                                        return
                                                                                html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-person20", css:map-rend-to-class(.)), $content)
                                    else
                                        (),
                                    if (child::occupation) then
                                        let $params := 
                                        ...
                                        return
                                                                                html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-person21", css:map-rend-to-class(.)), $content)
                                    else
                                        (),
                                    if (child::education) then
                                        html:block($config, ., ("tei-person22", css:map-rend-to-class(.)), education)
                                    else
                                        (),
                                    if (child::affiliation) then
                                        html:block($config, ., ("tei-person23", css:map-rend-to-class(.)), affiliation)
                                    else
                                        (),
                                    if (child::event) then
                                        html:block($config, ., ("tei-person24", css:map-rend-to-class(.)), event)
                                    else
                                        ()
                                )
                                ...
                                if ($parameters?mode="relations") then
                                    html:omit($config, ., ("tei-person25", css:map-rend-to-class(.)), .)
                                else
                                    if ($parameters?mode='list') then
                                        let $params := 
                                            map {
                                        ...
                                        return
                                                                                html:webcomponent(map:merge(($config, map:entry("template", true()))), ., ("tei-person37", css:map-rend-to-class(.)), $content, 'pb-highlight', map {"key": @xml:id, "scroll": true(), "emit": 'letter'})
                                    else
                                        $config?apply($config, ./node())
                    case element(placeName) return
                        if (parent::education or parent::affiliation) then
                            html:inline($config, ., ("tei-placeName1", css:map-rend-to-class(.)), .)
                        else
                            if ($parameters?mode="index" and (parent::birth or parent::death)) then
                                ...
                                return
                                                                html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-placeName2", css:map-rend-to-class(.)), $content)
                            else
                                if (ancestor::person or ancestor::place) then
                                    ...
                                    if ($parameters?mode="entities" and id(substring-after(@ref, '#'), root($parameters?root))/location/geo) then
                                        html:omit($config, ., ("tei-placeName4", css:map-rend-to-class(.)), .)
                                    else
                                        if ($parameters?mode="entities" and @type="bruneau" and id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/maguerre/index/index_lieux_maguerre.xml"))/location/geo) then
                                            html:webcomponent($config, ., ("tei-placeName5", css:map-rend-to-class(.)), ., 'pb-geolocation', map {"longitude": tokenize(id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/maguerre/index/index_lieux_maguerre.xml"))/location/geo, ' ')[2], "latitude": tokenize(id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/maguerre/index/index_lieux_maguerre.xml"))/location/geo, ' ')[1], "label": id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/maguerre/index/index_lieux_maguerre.xml"))/placeName, "key": substring-after(@ref, '#'), "scroll": true(), "emit": 'transcription'})
                                        else
                                            if ($parameters?mode="entities" and (@type="camp" or @type="ehri") and id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/ehri/index/EHRI_index_places.xml"))/location/geo) then
                                                ...
                                                if ($parameters?mode="entities" and @type="cds" and id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/cds/index/CdS_index_places.xml"))/location/geo) then
                                                    html:webcomponent($config, ., ("tei-placeName7", css:map-rend-to-class(.)), ., 'pb-geolocation', map {"longitude": tokenize(id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/cds/index/CdS_index_places.xml"))/location/geo, ' ')[2], "latitude": tokenize(id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/cds/index/CdS_index_places.xml"))/location/geo, ' ')[1], "label": id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/cds/index/CdS_index_places.xml"))/placeName, "key": substring-after(@ref, '#'), "scroll": true(), "emit": 'transcription'})
                                                else
                                                    if ($parameters?mode="entities" and @type="bi" and id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/bi/indexes/Ortsindex.xml"))/location/geo) then
                                                        html:webcomponent($config, ., ("tei-placeName8", css:map-rend-to-class(.)), ., 'pb-geolocation', map {"longitude": tokenize(id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/bi/indexes/Ortsindex.xml"))/location/geo, ' ')[2], "latitude": tokenize(id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/bi/indexes/Ortsindex.xml"))/location/geo, ' ')[1], "label": id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/bi/indexes/Ortsindex.xml"))/placeName, "key": substring-after(@ref, '#'), "scroll": true(), "emit": 'transcription'})
                                                    else
                                                        if ($parameters?mode="entities" and @type="tgb" and id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/rochlitz/index/indices.xml"))/location/geo) then
                                                            html:webcomponent($config, ., ("tei-placeName9", css:map-rend-to-class(.)), ., 'pb-geolocation', map {"longitude": tokenize(id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/rochlitz/index/indices.xml"))/location/geo, ' ')[2], "latitude": tokenize(id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/rochlitz/index/indices.xml"))/location/geo, ' ')[1], "label": id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/rochlitz/index/indices.xml"))/placeName, "key": substring-after(@ref, '#'), "scroll": true(), "emit": 'transcription'})
                                                        else
                                                            if ($parameters?mode="entities" and @type="pec" and id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/pec/index/Index_place.xml"))/location/geo) then
                                                                html:webcomponent($config, ., ("tei-placeName10", css:map-rend-to-class(.)), ., 'pb-geolocation', map {"longitude": tokenize(id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/pec/index/Index_place.xml"))/location/geo, ' ')[2], "latitude": tokenize(id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/pec/index/Index_place.xml"))/location/geo, ' ')[1], "label": id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/pec/index/Index_place.xml"))/placeName[1], "key": substring-after(@ref, '#'), "scroll": true(), "emit": 'transcription'})
                                                            else
                                                                if (@type="pec" and $parameters?mode='entities') then
                                                                    printcss:alternate($config, ., ("tei-placeName11", css:map-rend-to-class(.)), ., ., id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/pec/index/Index_place.xml")))
                                                                else
                                                                    if (@type="bi" and $parameters?mode='entities') then
                                                                        printcss:alternate($config, ., ("tei-placeName12", css:map-rend-to-class(.)), ., ., id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/bi/indexes/Ortsindex.xml")))
                                                                    else
                                                                        if (parent::org) then
                                                                            let $params := 
                                                                                map {
                                                                            ...
                                                                            return
                                                                                                                                                        html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-placeName13", css:map-rend-to-class(.)), $content)
                                                                        else
                                                                            html:inline($config, ., ("tei-placeName14", css:map-rend-to-class(.)), .)
                    case element(geo) return
                        (
                            html:webcomponent($config, ., ("tei-geo", css:map-rend-to-class(.)), ancestor::place/placeName[1], 'pb-geolocation', map {"latitude": tokenize(., ' ')[1], "longitude": tokenize(., ' ')[2], "scroll": true(), "emit": 'map', "label": ancestor::place/placeName[1]})
                        )

                    case element(affiliation) return
                        if (ancestor::org) then
                            (: rendition if ancestor org :)
                            html:inline($config, ., ("tei-affiliation1", css:map-rend-to-class(.)), .)
                        else
                            if (@when-iso) then
                                ...
                                return
                                                                html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-affiliation2", css:map-rend-to-class(.)), $content)
                            else
                                if (@from-iso) then
                                    ...
                                    return
                                                                        html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-affiliation3", css:map-rend-to-class(.)), $content)
                                else
                                    (: default rendition :)
                                    let $params := 
                                        map {
                                    ...
                                    return
                                                                        html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-affiliation4", css:map-rend-to-class(.)), $content)
                    case element(event) return
                        if ($parameters?mode='index' and parent::listEvent) then
                            ...
                            return
                                                        html:webcomponent(map:merge(($config, map:entry("template", true()))), ., ("tei-event1", css:map-rend-to-class(.)), $content, 'pb-highlight', map {"key": @xml:id, "scroll": true(), "emit": 'letter', "desc": desc})
                        else
                            if ($parameters?mode='list' and parent::listEvent) then
                                ...
                                return
                                                                html:webcomponent(map:merge(($config, map:entry("template", true()))), ., ("tei-event2", css:map-rend-to-class(.)), $content, 'pb-highlight', map {"key": @xml:id, "scroll": true(), "emit": 'letter'})
                            else
                                if (@when-iso) then
                                    let $params := 
                                        map {
                                    ...
                                    return
                                                                        html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-event3", css:map-rend-to-class(.)), $content)
                                else
                                    let $params := 
                                        map {
                                            "content": ./p
                                    ...
                                    return
                                                                        html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-event4", css:map-rend-to-class(.)), $content)
                    case element(place) return
                        if ($parameters?mode='index' and location/geo) then
                            (
                                html:webcomponent($config, ., ("tei-place6", css:map-rend-to-class(.)), placeName[1], 'pb-highlight', map {"key": @xml:id, "subscribe": 'index', "emit": 'map'}),
                                html:block($config, ., ("tei-place7", css:map-rend-to-class(.)), string-join(* except (location|idno), ', ')),
                                html:block($config, ., ("tei-place8", css:map-rend-to-class(.)), string-join(location/address, ', ')),
                                if (location/geo) then
                                    html:block($config, ., ("tei-place9", css:map-rend-to-class(.)), location/geo)
                                else
                                    (),
                                if (child::bibl) then
                                    html:block($config, ., ("tei-place10", css:map-rend-to-class(.)), bibl)
                                else
                                    ()
                            )
                            ...
                            if ($parameters?mode='index' and not(location/geo)) then
                                html:webcomponent($config, ., ("tei-place11", css:map-rend-to-class(.)), placeName[1], 'pb-highlight', map {"key": @xml:id, "subscribe": 'index', "emit": 'map'})
                            else
                                if ($parameters?mode='list') then
                                    (
                                        if (location/geo) then
                                            ...
                                            return
                                                                                        html:webcomponent(map:merge(($config, map:entry("template", true()))), ., ("tei-place12", css:map-rend-to-class(.)), $content, 'pb-highlight', map {"key": @xml:id, "emit": 'index'})
                                        else
                                            (),
                                        if (not(location/geo)) then
                                            ...
                                            return
                                                                                        html:webcomponent(map:merge(($config, map:entry("template", true()))), ., ("tei-place13", css:map-rend-to-class(.)), $content, 'pb-highlight', map {"key": @xml:id, "emit": 'index'})
                                        else
                                            ()
                                    )
                        ...
                        if ($parameters?mode='facets') then
                            (
                                if (not(child::idno)) then
                                    ...
                                    return
                                                                        html:webcomponent(map:merge(($config, map:entry("template", true()))), ., ("tei-org1", css:map-rend-to-class(.)), $content, 'pb-highlight', map {"key": @xml:id, "subscribe": 'letter', "emit": 'index'})
                                else
                                    (),
                                if (child::idno) then
                                    let $params := 
                                    ...
                                    return
                                                                        html:webcomponent(map:merge(($config, map:entry("template", true()))), ., ("tei-org2", css:map-rend-to-class(.)), $content, 'pb-highlight', map {"key": @xml:id, "subscribe": 'letter', "emit": 'index', "viaf": idno})
                                else
                                    (),
                                if (desc) then
                                    html:block($config, ., ("tei-org3", css:map-rend-to-class(.)), desc[1])
                                else
                                    (),
                                if (note) then
                                    html:block($config, ., ("tei-org4", css:map-rend-to-class(.)), note)
                                else
                                    (),
                                if (child::placeName/@from-iso) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-org5", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (child::placeName/not(@from-iso)) then
                                    ...
                                    return
                                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-org6", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (placeName/location/geo) then
                                    html:block($config, ., ("tei-org7", css:map-rend-to-class(.)), placeName/location/geo)
                                else
                                    (),
                                if (child::persName) then
                                    let $params := 
                                    ...
                                    return
                                                                        html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-org8", css:map-rend-to-class(.)), $content)
                                else
                                    ()
                            )
                            ...
                            if ($parameters?mode='index') then
                                (
                                    if (not(child::idno)) then
                                        ...
                                        return
                                                                                html:webcomponent(map:merge(($config, map:entry("template", true()))), ., ("tei-org9", css:map-rend-to-class(.)), $content, 'pb-highlight', map {"key": @xml:id, "subscribe": 'letter', "emit": 'index'})
                                    else
                                        (),
                                    if (child::idno) then
                                        let $params := 
                                        ...
                                        return
                                                                                html:webcomponent(map:merge(($config, map:entry("template", true()))), ., ("tei-org10", css:map-rend-to-class(.)), $content, 'pb-highlight', map {"key": @xml:id, "subscribe": 'letter', "emit": 'index', "viaf": idno})
                                    else
                                        (),
                                    if (desc) then
                                        html:block($config, ., ("tei-org11", css:map-rend-to-class(.)), desc[1])
                                    else
                                        (),
                                    if (note) then
                                        html:block($config, ., ("tei-org12", css:map-rend-to-class(.)), note)
                                    else
                                        (),
                                    if (child::placeName/@from-iso) then
                                        let $params := 
                                        ...
                                        return
                                                                                html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-org13", css:map-rend-to-class(.)), $content)
                                    else
                                        (),
                                    if (child::placeName/not(@from-iso)) then
                                        let $params := 
                                        ...
                                        return
                                                                                html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-org14", css:map-rend-to-class(.)), $content)
                                    else
                                        (),
                                    if (placeName/location/geo) then
                                        html:block($config, ., ("tei-org15", css:map-rend-to-class(.)), placeName/location/geo)
                                    else
                                        (),
                                    if (child::persName) then
                                        let $params := 
                                        ...
                                        return
                                                                                html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-org16", css:map-rend-to-class(.)), $content)
                                    else
                                        ()
                                )
                                ...
                                if ($parameters?mode='list') then
                                    ...
                                    return
                                                                        html:webcomponent(map:merge(($config, map:entry("template", true()))), ., ("tei-org21", css:map-rend-to-class(.)), $content, 'pb-highlight', map {"key": @xml:id, "scroll": true(), "emit": 'letter'})
                                else
                                    $config?apply($config, ./node())
                    case element(orgName) return
                        if (parent::education or parent::affiliation) then
                            html:inline($config, ., ("tei-orgName1", css:map-rend-to-class(.)), .)
                        else
                            if (ancestor::org or ancestor::place or ancestor::person) then
                                ...
                                if ($parameters?mode='facets') then
                                    ...
                                    if ($parameters?mode='entities' and ((@type="bi" and id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/bi/indexes/Organisationsindex_Gruppenindex.xml"))) or (@type="pec" and id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/pec/index/Index_organizations.xml"))) or (@type="ehri" and id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/ehri/index/EHRI_index_organizations.xml"))))) then
                                        html:webcomponent($config, ., ("tei-orgName4", css:map-rend-to-class(.)), ., 'pb-highlight', map {"key": substring-after(@ref, '#'), "scroll": true(), "emit": 'letter'})
                                    else
                                        if (@from-iso) then
                                            let $params := 
                                                map {
                                            ...
                                            return
                                                                                        html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-orgName5", css:map-rend-to-class(.)), $content)
                                        else
                                            $config?apply($config, ./node())
                    case element(sex) return
                        if (@value="2") then
                            ...
                            return
                                                        html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-sex1", css:map-rend-to-class(.)), $content)
                        else
                            if (@value="1") then
                                let $params := 
                                    map {
                                ...
                                return
                                                                html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-sex2", css:map-rend-to-class(.)), $content)
                            else
                                $config?apply($config, ./node())
                    ...
                    case element(specDesc) return
                        ...
                        return
                                                html:row(map:merge(($config, map:entry("template", true()))), ., ("tei-specDesc", css:map-rend-to-class(.)), $content)
                    case element(specList) return
                        ...
                        return
                                                html:list(map:merge(($config, map:entry("template", true()))), ., ("tei-specList", css:map-rend-to-class(.)), $content, ())
                    case element(egXML) return
                        html:webcomponent($config, ., ("tei-egXML2", css:map-rend-to-class(.)), text(), 'pb-code-highlight', map {"language": (@language, 'xml')[1], "line-numbers": true(), "theme": 'coy'})
                    case element(att) return
                        (: default rendition :)
                        html:inline($config, ., ("tei-att", css:map-rend-to-class(.)), .)
                    case element(schemaSpec) return
                        ...
                        return
                                                html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-schemaSpec", css:map-rend-to-class(.)), $content)
                        ...
                        if (parent::schemaSpec) then
                            (
                                if (@except="") then
                                    ...
                                    return
                                                                        html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-moduleRef1", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (@except and not(@except="")) then
                                    ...
                                    return
                                                                        html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-moduleRef2", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (@include) then
                                    let $params := 
                                    ...
                                    return
                                                                        html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-moduleRef3", css:map-rend-to-class(.)), $content)
                                else
                                    ()
                            )
                    ...
                    case element(elementSpec) return
                        if (@mode='change') then
                            ...
                            return
                                                        html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-elementSpec", css:map-rend-to-class(.)), $content)
                        else
                            $config?apply($config, ./node())
                    ...
                    case element(idno) return
                        if (@type="GND") then
                            ...
                            return
                                                        html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-idno1", css:map-rend-to-class(.)), $content)
                        else
                            if (@type="VIAF") then
                                let $params := 
                                    map {
                                ...
                                return
                                                                html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-idno2", css:map-rend-to-class(.)), $content)
                            else
                                if (@type="PND") then
                                    let $params := 
                                        map {
                                    ...
                                    return
                                                                        html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-idno3", css:map-rend-to-class(.)), $content)
                                else
                                    $config?apply($config, ./node())
                    case element(stamp) return
                        if (ancestor::additions) then
                            ...
                            return
                                                        html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-stamp1", css:map-rend-to-class(.)), $content)
                        else
                            let $params := 
                                map {
                                    "rend": if (@rend="align(center)") then 'text-align:center;' else  (if ((@rend="align(right)") or (@rend="margin(right)")) then 'text-align:right;' else     (if (@rend="align(left)") then 'text-align:left;' else         (if (@rend="indent") then 'text-indent: 15%;' else ''))),
                            ...
                            return
                                                        html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-stamp2", css:map-rend-to-class(.)), $content)
                    case element(change) return
                        if ($parameters?mode='citation') then
                            (: rendition for citation mode :)
                            html:inline($config, ., ("tei-change", css:map-rend-to-class(.)), format-date(@when-iso, '[MNn] [D10], [Y]', 'en', 'AD', 'GB'))
                        else
                            $config?apply($config, ./node())
                    case element(relation) return
                        if (@mutual and $parameters?mode="index") then
                            ...
                            return
                                                        html:omit(map:merge(($config, map:entry("template", true()))), ., ("tei-relation", css:map-rend-to-class(.)), $content)
                        else
                            $config?apply($config, ./node())
                    case element(term) return
                        if ($parameters?mode='facets') then
                            html:webcomponent($config, ., ("tei-term1", css:map-rend-to-class(.)), id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/ehri/index/EHRI_index_terms.xml")), 'pb-highlight', map {"key": substring-after(@ref, '#'), "subscribe": 'letter', "emit": 'facets'})
                        else
                            if ($parameters?mode='entities' and id(substring-after(@ref, '#'), doc("/db/apps/discholed/data/ehri/index/EHRI_index_terms.xml"))) then
                                html:webcomponent($config, ., ("tei-term2", css:map-rend-to-class(.)), ., 'pb-highlight', map {"key": substring-after(@ref, '#'), "scroll": true(), "emit": 'letter'})
                            else
                                $config?apply($config, ./node())
                        ...
                        if ($parameters?mode='index') then
                            (
                                if (child::author) then
                                    html:inline($config, ., ("tei-monogr1", css:map-rend-to-class(.)), string-join(author, ", "))
                                else
                                    (),
                                if (child::editor) then
                                    html:inline($config, ., ("tei-monogr2", css:map-rend-to-class(.)), string-join(editor, ", "))
                                else
                                    (),
                                if (child::title) then
                                    html:inline($config, ., ("tei-monogr3", css:map-rend-to-class(.)), string-join(title, ", "))
                                else
                                    (),
                                if (child::imprint) then
                                    html:inline($config, ., ("tei-monogr4", css:map-rend-to-class(.)), imprint)
                                else
                                    ()
                            )
                            ...
                            if ($parameters?mode='facets') then
                                (
                                    if (child::author) then
                                        html:inline($config, ., ("tei-monogr5", css:map-rend-to-class(.)), string-join(author, ", "))
                                    else
                                        (),
                                    if (child::editor) then
                                        html:inline($config, ., ("tei-monogr6", css:map-rend-to-class(.)), string-join(editor, ", "))
                                    else
                                        (),
                                    if (child::title) then
                                        html:inline($config, ., ("tei-monogr7", css:map-rend-to-class(.)), string-join(title, ", "))
                                    else
                                        (),
                                    if (child::imprint) then
                                        html:inline($config, ., ("tei-monogr8", css:map-rend-to-class(.)), imprint)
                                    else
                                        ()
                                )
                                ...
                                if ($parameters?mode='list') then
                                    (
                                        if (child::author) then
                                            html:inline($config, ., ("tei-monogr9", css:map-rend-to-class(.)), string-join(author, ", "))
                                        else
                                            (),
                                        if (child::editor and not(child::author)) then
                                            html:inline($config, ., ("tei-monogr10", css:map-rend-to-class(.)), string-join(editor, ", "))
                                        else
                                            (),
                                        if (child::title) then
                                            html:inline($config, ., ("tei-monogr11", css:map-rend-to-class(.)), title[1])
                                        else
                                            ()
                                    )
                    ...
                    case element(biblStruct) return
                        if ($parameters?mode='index') then
                            ...
                            return
                                                        html:webcomponent(map:merge(($config, map:entry("template", true()))), ., ("tei-biblStruct1", css:map-rend-to-class(.)), $content, 'pb-highlight', map {"key": @xml:id, "subscribe": 'letter', "emit": 'index'})
                        else
                            if ($parameters?mode='list') then
                                (: rendition for list mode :)
                                html:webcomponent($config, ., ("tei-biblStruct2", css:map-rend-to-class(.)), ., 'pb-highlight', map {"key": @xml:id, "scroll": true(), "emit": 'letter'})
                            else
                                (: default rendition :)
                                html:block($config, ., ("tei-biblStruct3", css:map-rend-to-class(.)), .)
                        ...
                        if ($parameters?mode='index' or $parameters?mode='list' or $parameters?mode='facets') then
                            (
                                if (child::pubPlace/text()) then
                                    html:inline($config, ., ("tei-imprint1", css:map-rend-to-class(.)), pubPlace)
                                else
                                    (),
                                if (child::publisher/text()) then
                                    html:inline($config, ., ("tei-imprint2", css:map-rend-to-class(.)), publisher)
                                else
                                    (),
                                if (child::date[@from-iso] or child::date[@notBefore-iso]) then
                                    html:inline($config, ., ("tei-imprint3", css:map-rend-to-class(.)), date)
                                else
                                    (),
                                if (child::date[@when-iso]) then
                                    html:inline($config, ., ("tei-imprint4", css:map-rend-to-class(.)), if (date/text()) then (date/text()) else (date/when-iso))
                                else
                                    (),
                                if (child::date[@when]) then
                                    html:inline($config, ., ("tei-imprint5", css:map-rend-to-class(.)), if (date/text()) then (date/text()) else (date/when))
                                else
                                    (),
                                if (child::biblScope[@unit="page"]) then
                                    ...
                                    return
                                                                        html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-imprint6", css:map-rend-to-class(.)), $content)
                                else
                                    (),
                                if (child::biblScope[@unit="volume"]) then
                                    ...
                                    return
                                                                        html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-imprint7", css:map-rend-to-class(.)), $content)
                                else
                                    ()
                            )
                    ...
                    case element(analytic) return
                        if ($parameters?mode='index') then
                            (
                                if (child::author) then
                                    html:inline($config, ., ("tei-analytic1", css:map-rend-to-class(.)), string-join(author, ", "))
                                else
                                    (),
                                if (child::editor) then
                                    html:inline($config, ., ("tei-analytic2", css:map-rend-to-class(.)), string-join(editor, ", "))
                                else
                                    (),
                                if (child::title) then
                                    html:inline($config, ., ("tei-analytic3", css:map-rend-to-class(.)), string-join(title, ", "))
                                else
                                    ()
                            )
                            ...
                            if ($parameters?mode='list') then
                                (
                                    if (child::author) then
                                        html:inline($config, ., ("tei-analytic4", css:map-rend-to-class(.)), string-join(author, ", "))
                                    else
                                        (),
                                    if (child::editor) then
                                        html:inline($config, ., ("tei-analytic5", css:map-rend-to-class(.)), string-join(editor, ", "))
                                    else
                                        (),
                                    if (child::title) then
                                        html:inline($config, ., ("tei-analytic6", css:map-rend-to-class(.)), string-join(title, ", "))
                                    else
                                        ()
                                )
                    ...
                    case element(metamark) return
                        ...
                        return
                                                html:block(map:merge(($config, map:entry("template", true()))), ., ("tei-metamark3", css:map-rend-to-class(.)), $content)
                    case element(emph) return
                        html:inline($config, ., ("tei-emph", css:map-rend-to-class(.)), .)
                    case element(handShift) return
                        printcss:alternate($config, ., ("tei-handShift", css:map-rend-to-class(.)), ., "[Shift in the document hand]", id(substring-after(@new, '#'), root($parameters?root))/p[@xml:lang="en"])
                    case element(delSpan) return
                        printcss:alternate($config, ., ("tei-delSpan", css:map-rend-to-class(.)), ., "[From here, a large part of the text has been strikethrough]", id(substring-after(@hand, '#'), root($parameters?root))/p[@xml:lang="en"])
                    case element(education) return
                        ...
                        return
                                                html:inline(map:merge(($config, map:entry("template", true()))), ., ("tei-education", css:map-rend-to-class(.)), $content)
                    case element(location) return
                        (
                            if (/geo) then
                                printcss:alternate($config, ., ("tei-location", css:map-rend-to-class(.)), ., /geo, let $address := ../location/address let $placenames := string-join(../placeName/text(), ', ') let $geo := /geo  let $country := string-join(../country, ', ') return <div class='card_index'> {   if ($country) then     <p>{$country}</p>   else (),   if ($placenames) then     <p>{$placenames}</p>   else (),   if ($address) then     <p>Address:       {for $child in $address/*       return concat(string($child), ', ')}     </p>   else (),   if ($geo) then     <p>Location: <span style='color: blue;'>{$geo}</span></p>   else () } </div>)
                            else
                                ()
                        )
